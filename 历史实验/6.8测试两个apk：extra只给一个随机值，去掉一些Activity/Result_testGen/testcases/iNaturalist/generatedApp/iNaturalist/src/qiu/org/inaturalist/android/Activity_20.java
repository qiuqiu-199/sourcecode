...
public class Activity_20 extends Activity
{
	public void launch(){
		...
		intent.setType("vnd.android.cursor.item/vnd.google.observation");
		startActivity(intent);
		//android.intent.action.INSERT;;android.intent.category.DEFAULT;;null;;vnd.android.cursor.item/vnd.google.observation;;
	}
