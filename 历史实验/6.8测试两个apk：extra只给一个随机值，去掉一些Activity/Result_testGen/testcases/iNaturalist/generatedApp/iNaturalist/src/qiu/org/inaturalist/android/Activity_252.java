...
public class Activity_252 extends Activity
{
	public void launch(){
		...
		//null;;null;;null;;null;;double->latitude->0.0,double->accuracy->0.0,String->new com.adobe.xmp.properties.XMPPropertyInfo->abcde,double->longitude->0.0,String->iconic_taxon_name->abcde,
	}
