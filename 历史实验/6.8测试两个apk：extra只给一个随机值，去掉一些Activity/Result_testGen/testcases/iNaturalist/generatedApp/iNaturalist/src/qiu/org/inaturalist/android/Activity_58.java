...
public class Activity_58 extends Activity
{
	public void launch(){
		...
		//null;;null;;null;;null;;String->observation->abcde,String->obs_photo_filename->abcde,double->latitude->0.0,int->observation_id->0,int->observation_id_internal->0,String->new com.adobe.xmp.properties.XMPPropertyInfo->abcde,double->longitude->0.0,Serializable->observed_on->SerializableObj,String->obs_photo_url->abcde,Serializable->taxon_suggestions->SerializableObj,
	}
