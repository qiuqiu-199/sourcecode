...
public class Activity_64 extends Activity
{
	public void launch(){
		...
		//null;;null;;null;;null;;String->query->abcde,boolean->is_shared_on_app->true,String->new com.adobe.xmp.properties.XMPPropertyInfo->abcde,Serializable->user_search_observations_result->SerializableObj,
	}
