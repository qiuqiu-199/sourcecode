...
public class Activity_298 extends Activity
{
	public void launch(){
		...
		//null;;null;;?;;null;;String->id_remarks->abcde,boolean->from_suggestion->false,int->taxon_id->0,boolean->scroll_to_comments_bottom->true,String->observation_json_result->abcde,Serializable->observation_result->SerializableObj,String->observation->abcde,String->species_guess->abcde,boolean->show_comments->false,String->taxon_name->abcde,boolean->read_only->false,boolean->is_shared_on_app->true,String->new com.adobe.xmp.properties.XMPPropertyInfo->abcde,boolean->reload->true,
	}
