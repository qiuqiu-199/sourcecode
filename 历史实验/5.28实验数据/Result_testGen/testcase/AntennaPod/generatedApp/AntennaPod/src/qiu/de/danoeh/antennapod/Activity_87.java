...
public class Activity_87 extends Activity
{
	public void launch(){
		...
		//android.intent.action.SEND;;null;;notEmpty;;null;;String->android.intent.extra.TEXT->999999999999999999999999999999999999999999999999999,String->arg.feedurl->!@#$%^ds:+_,String->title->abcde,
	}
