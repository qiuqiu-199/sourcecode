...
public class Activity_120 extends Activity
{
	public void launch(){
		...
		//null;;null;;null;;null;;Parcelable->operation_result->ParcelableObj,String->user_id->abcde,Parcelable->data->ParcelableObj,String->package_name->!@#$%^ds:+_,byteArray->package_signature->Byte.MAX_VALUE,
	}
