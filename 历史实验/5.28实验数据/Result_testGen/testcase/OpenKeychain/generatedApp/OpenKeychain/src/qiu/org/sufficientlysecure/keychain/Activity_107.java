...
public class Activity_107 extends Activity
{
	public void launch(){
		...
		//android.nfc.action.TAG_DISCOVERED;;null;;null;;null;;Parcelable->operation_result->ParcelableObj,boolean->skip_first_time->true,int->init_frag->0,Parcelable->android.nfc.extra.TAG->ParcelableObj,
	}
