...
public class Activity_61 extends Activity
{
	public void launch(){
		...
		//android.intent.action.SEND_MULTIPLE;;null;;notEmpty;;application/autocrypt-setup;;Parcelable->android.intent.extra.STREAM->ParcelableObj,String->android.intent.extra.TEXT->abcde,
	}
