...
public class Activity_389 extends Activity
{
	public void launch(){
		...
		//android.nfc.action.NDEF_DISCOVERED;;null;;null;;null;;boolean->create_yubi_key->true,Parcelable->token_info->ParcelableObj,String->name->abcde,boolean->first_time->false,Parcelable->android.nfc.extra.TAG->ParcelableObj,String->email->abcde,
	}
