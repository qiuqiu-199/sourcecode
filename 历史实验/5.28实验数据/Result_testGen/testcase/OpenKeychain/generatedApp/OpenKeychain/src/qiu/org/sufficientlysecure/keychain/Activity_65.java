...
public class Activity_65 extends Activity
{
	public void launch(){
		...
		//android.intent.action.VIEW;;null;;notEmpty;;application/autocrypt-setup;;Parcelable->android.intent.extra.STREAM->ParcelableObj,String->android.intent.extra.TEXT->abcde,
	}
