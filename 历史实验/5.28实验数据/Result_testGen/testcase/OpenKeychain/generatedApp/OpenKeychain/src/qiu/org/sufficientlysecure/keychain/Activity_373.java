...
public class Activity_373 extends Activity
{
	public void launch(){
		...
		//android.nfc.action.TAG_DISCOVERED;;null;;null;;null;;boolean->create_yubi_key->true,Parcelable->token_info->ParcelableObj,String->name->abcde,boolean->first_time->true,Parcelable->android.nfc.extra.TAG->ParcelableObj,String->email->abcde,
	}
