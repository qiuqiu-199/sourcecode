...
public class Activity_75 extends Activity
{
	public void launch(){
		...
		//null;;null;;null;;null;;int->active_days->0,int->rest_days->Integer.MAX_VALUE,String->start->abcde,String->rule->999999999999999999999999999999999999999999999999999,
	}
