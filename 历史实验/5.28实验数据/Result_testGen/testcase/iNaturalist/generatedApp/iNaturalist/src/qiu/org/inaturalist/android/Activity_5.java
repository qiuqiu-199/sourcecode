...
public class Activity_5 extends Activity
{
	public void launch(){
		...
		//notEmpty;;null;;notEmpty;;null;;boolean->from_suggestion->true,double->latitude->Double.MIN_VALUE,int->taxon_id->Integer.MAX_VALUE,double->accuracy->0.0,Serializable->taxon_result->SerializableObj,IntegerArrayList->project_ids->Integer.MAX_VALUE,String->photoUri->!@#$%^ds:+_,int->observation_project->0,String->id_name->abcde,int->field_id->Integer.MAX_VALUE,
	}
