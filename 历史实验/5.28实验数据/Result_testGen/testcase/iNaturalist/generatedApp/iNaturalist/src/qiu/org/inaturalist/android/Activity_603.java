...
public class Activity_603 extends Activity
{
	public void launch(){
		...
		//null;;null;;null;;null;;int->observation_id->Integer.MIN_VALUE,int->observation_id_internal->Integer.MAX_VALUE,int->suggestion_index->0,String->observation_json->abcde,
	}
