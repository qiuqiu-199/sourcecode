...
public class Activity_555 extends Activity
{
	public void launch(){
		...
		//FacebookDialogFragment;;null;;null;;null;;Parcelable->content->ParcelableObj,Bundle->com.facebook.platform.protocol.BRIDGE_ARGS->BundleObj,int->com.facebook.platform.protocol.PROTOCOL_VERSION->0,Bundle->com.facebook.platform.protocol.METHOD_ARGS->BundleObj,String->com.facebook.platform.protocol.CALL_ID->abcde,String->action_id->999999999999999999999999999999999999999999999999999,
	}
