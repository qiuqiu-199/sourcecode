...
public class Activity_594 extends Activity
{
	public void launch(){
		...
		//null;;null;;null;;null;;int->observation_id->Integer.MIN_VALUE,int->observation_id_internal->0,int->suggestion_index->0,String->observation_json->abcde,
	}
