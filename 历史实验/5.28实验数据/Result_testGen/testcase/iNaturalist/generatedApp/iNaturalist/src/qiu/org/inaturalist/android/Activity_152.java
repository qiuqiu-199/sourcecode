...
public class Activity_152 extends Activity
{
	public void launch(){
		...
		//explore_get_species_result;;null;;null;;null;;Serializable->results->SerializableObj,boolean->is_shared_on_app->true,int->active_tab->0,String->new com.adobe.xmp.properties.XMPPropertyInfo->abcde,String->error->abcde,Serializable->search_filters->SerializableObj,
	}
