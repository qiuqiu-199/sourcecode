...
public class Activity_344 extends Activity
{
	public void launch(){
		...
		//null;;null;;null;;null;;String->species_guess->abcde,int->observation_id->0,int->observation_id_internal->0,boolean->suggest_id->false,String->observation_json->abcde,String->new com.adobe.xmp.properties.XMPPropertyInfo->999999999999999999999999999999999999999999999999999,boolean->show_unknown->false,int->field_id->0,
	}
