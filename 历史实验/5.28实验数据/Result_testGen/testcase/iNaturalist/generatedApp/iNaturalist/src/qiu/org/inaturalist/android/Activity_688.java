...
public class Activity_688 extends Activity
{
	public void launch(){
		...
		intent.putExtra("research_grade", false);
		...
		intent.putExtra("taxon_suggestion", Integer.MIN_VALUE);
		startActivity(intent);
		//notEmpty;;null;;null;;null;;int->taxon_suggestion->Integer.MIN_VALUE,Serializable->taxon_observation_bounds_result->SerializableObj,boolean->download_taxon->false,Serializable->taxon_result->SerializableObj,boolean->research_grade->false,Serializable->observation->SerializableObj,boolean->is_shared_on_app->true,String->new com.adobe.xmp.properties.XMPPropertyInfo->!@#$%^ds:+_,
	}
