...
public class Activity_216 extends Activity
{
	public void launch(){
		...
		//notEmpty;;null;;null;;null;;Serializable->data_quality_metrics_result->SerializableObj,Serializable->observation->SerializableObj,boolean->is_shared_on_app->false,String->new com.adobe.xmp.properties.XMPPropertyInfo->!@#$%^ds:+_,
	}
