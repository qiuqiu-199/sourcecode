...
public class Activity_626 extends Activity
{
	public void launch(){
		...
		//null;;null;;null;;null;;int->observation_id->0,int->observation_id_internal->Integer.MAX_VALUE,int->suggestion_index->Integer.MIN_VALUE,
	}
