...
public class Activity_278 extends Activity
{
	public void launch(){
		...
		intent.setAction("species_count_result");
		...
		//species_count_result;;null;;notEmpty;;null;;Serializable->results->SerializableObj,Serializable->observations->SerializableObj,Serializable->user->SerializableObj,boolean->first_sync->true,boolean->sync_canceled->false,String->username->999999999999999999999999999999999999999999999999999,Serializable->species_count_result->SerializableObj,Serializable->identifications->SerializableObj,boolean->is_shared_on_app->false,String->new com.adobe.xmp.properties.XMPPropertyInfo->abcde,boolean->noConnectivity->true,String->error->999999999999999999999999999999999999999999999999999,boolean->from_obs_editor->false,
	}
