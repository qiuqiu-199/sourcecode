...
public class Activity_75 extends Activity
{
	public void launch(){
		...
		//null;;null;;null;;null;;String->obs_photo_filename->abcde,double->latitude->0.0,int->observation_id->0,int->observation_id_internal->0,double->longitude->0.0,Serializable->observed_on->SerializableObj,String->obs_photo_url->!@#$%^ds:+_,
	}
