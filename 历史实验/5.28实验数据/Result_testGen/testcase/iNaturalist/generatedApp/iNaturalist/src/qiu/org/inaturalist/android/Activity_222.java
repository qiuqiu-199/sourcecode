...
public class Activity_222 extends Activity
{
	public void launch(){
		...
		intent.putExtra("guide_xml_result", "!@#$%^ds:+_");
		startActivity(intent);
		//null;;null;;null;;null;;String->guide_xml_result->!@#$%^ds:+_,String->new com.adobe.xmp.properties.XMPPropertyInfo->abcde,Serializable->guide->SerializableObj,
	}
