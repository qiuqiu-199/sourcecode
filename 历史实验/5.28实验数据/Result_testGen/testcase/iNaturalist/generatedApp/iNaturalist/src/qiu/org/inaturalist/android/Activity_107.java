...
public class Activity_107 extends Activity
{
	public void launch(){
		...
		//null;;null;;null;;null;;Serializable->all_annotations->SerializableObj,String->new com.adobe.xmp.properties.XMPPropertyInfo->abcde,String->result->!@#$%^ds:+_,Serializable->search_filters->SerializableObj,
	}
