...
public class Activity_823 extends Activity
{
	public void launch(){
		...
		intent.putExtra("search_hint_text", "abcde");
		startActivity(intent);
		//null;;null;;null;;null;;String->search_hint_text->abcde,boolean->is_user->true,String->search_url->abcde,String->result_viewer_activity_param_name->999999999999999999999999999999999999999999999999999,boolean->return_result->true,String->new com.adobe.xmp.properties.XMPPropertyInfo->999999999999999999999999999999999999999999999999999,Serializable->result_viewer_activity->SerializableObj,
	}
