...
public class Activity_494 extends Activity
{
	public void launch(){
		...
		//user_details_result;;null;;null;;null;;Serializable->observations->SerializableObj,Serializable->identifications->SerializableObj,Serializable->user->SerializableObj,String->username->!@#$%^ds:+_,boolean->is_shared_on_app->true,String->new com.adobe.xmp.properties.XMPPropertyInfo->!@#$%^ds:+_,String->error->abcde,Serializable->species_count_result->SerializableObj,
	}
