...
public class Activity_32 extends Activity
{
	public void launch(){
		...
		//null;;null;;null;;null;;boolean->login->true,boolean->show_skip->true,String->new com.adobe.xmp.properties.XMPPropertyInfo->!@#$%^ds:+_,String->accountType->abcde,String->authAccount->!@#$%^ds:+_,Parcelable->com.facebook.LoginFragment:Result->ParcelableObj,
	}
