...
public class Activity_468 extends Activity
{
	public void launch(){
		...
		intent.setAction("user_observations_result");
		...
		//user_observations_result;;null;;null;;null;;Serializable->observations->SerializableObj,Serializable->identifications->SerializableObj,Serializable->user->SerializableObj,String->username->999999999999999999999999999999999999999999999999999,boolean->is_shared_on_app->false,String->new com.adobe.xmp.properties.XMPPropertyInfo->!@#$%^ds:+_,String->error->abcde,Serializable->species_count_result->SerializableObj,
	}
