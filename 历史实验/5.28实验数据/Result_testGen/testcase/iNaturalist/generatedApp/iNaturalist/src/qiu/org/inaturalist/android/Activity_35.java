...
public class Activity_35 extends Activity
{
	public void launch(){
		...
		//null;;null;;null;;null;;boolean->login->true,boolean->show_skip->true,String->new com.adobe.xmp.properties.XMPPropertyInfo->!@#$%^ds:+_,String->accountType->!@#$%^ds:+_,String->authAccount->abcde,Parcelable->com.facebook.LoginFragment:Result->ParcelableObj,
	}
