...
public class Activity_80 extends Activity
{
	public void launch(){
		...
		//null;;null;;null;;null;;String->query->!@#$%^ds:+_,boolean->is_shared_on_app->true,String->new com.adobe.xmp.properties.XMPPropertyInfo->!@#$%^ds:+_,Serializable->user_search_observations_result->SerializableObj,
	}
