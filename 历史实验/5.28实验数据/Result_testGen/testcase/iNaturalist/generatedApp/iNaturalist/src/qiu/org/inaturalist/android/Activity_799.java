...
public class Activity_799 extends Activity
{
	public void launch(){
		...
		//null;;null;;null;;null;;String->observation->abcde,boolean->show_comments->true,boolean->read_only->true,boolean->scroll_to_comments_bottom->true,boolean->reload->true,
	}
