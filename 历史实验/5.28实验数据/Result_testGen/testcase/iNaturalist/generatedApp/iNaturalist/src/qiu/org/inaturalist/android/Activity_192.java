...
public class Activity_192 extends Activity
{
	public void launch(){
		...
		//null;;null;;null;;null;;boolean->read_only->true,Serializable->observation->SerializableObj,String->observation_json->!@#$%^ds:+_,String->new com.adobe.xmp.properties.XMPPropertyInfo->!@#$%^ds:+_,
	}
