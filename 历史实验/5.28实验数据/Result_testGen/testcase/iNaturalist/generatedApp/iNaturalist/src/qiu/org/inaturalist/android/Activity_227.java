...
public class Activity_227 extends Activity
{
	public void launch(){
		...
		intent.putExtra("from_obs_editor", false);
		...
		intent.putExtra("username", "999999999999999999999999999999999999999999999999999");
		...
		//user_details_result;;null;;notEmpty;;null;;Serializable->results->SerializableObj,Serializable->observations->SerializableObj,Serializable->user->SerializableObj,boolean->first_sync->true,boolean->sync_canceled->true,String->username->999999999999999999999999999999999999999999999999999,Serializable->species_count_result->SerializableObj,Serializable->identifications->SerializableObj,boolean->is_shared_on_app->true,String->new com.adobe.xmp.properties.XMPPropertyInfo->999999999999999999999999999999999999999999999999999,boolean->noConnectivity->true,String->error->abcde,boolean->from_obs_editor->false,
	}
