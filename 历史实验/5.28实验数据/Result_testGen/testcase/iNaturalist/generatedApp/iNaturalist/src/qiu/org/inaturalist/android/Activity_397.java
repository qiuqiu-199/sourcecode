...
public class Activity_397 extends Activity
{
	public void launch(){
		...
		//null;;null;;null;;null;;Serializable->observation_id_internal->SerializableObj,boolean->is_new_observation->true,Serializable->observation_id->SerializableObj,int->current_photo_index->0,boolean->read_only->true,
	}
