...
public class Activity_629 extends Activity
{
	public void launch(){
		...
		//null;;null;;null;;null;;int->observation_id->0,int->observation_id_internal->0,int->suggestion_index->Integer.MIN_VALUE,
	}
