...
public class Activity_422 extends Activity
{
	public void launch(){
		...
		//null;;null;;null;;null;;boolean->is_new_observation->false,int->observation_id->Integer.MAX_VALUE,int->observation_id_internal->Integer.MIN_VALUE,int->current_photo_index->Integer.MIN_VALUE,boolean->read_only->false,
	}
