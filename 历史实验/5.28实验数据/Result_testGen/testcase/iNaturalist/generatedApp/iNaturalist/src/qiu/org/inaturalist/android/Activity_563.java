...
public class Activity_563 extends Activity
{
	public void launch(){
		...
		//DeviceShareDialogFragment;;null;;null;;null;;Parcelable->content->ParcelableObj,Bundle->com.facebook.platform.protocol.BRIDGE_ARGS->BundleObj,int->com.facebook.platform.protocol.PROTOCOL_VERSION->0,Bundle->com.facebook.platform.protocol.METHOD_ARGS->BundleObj,String->com.facebook.platform.protocol.CALL_ID->999999999999999999999999999999999999999999999999999,String->action_id->!@#$%^ds:+_,
	}
