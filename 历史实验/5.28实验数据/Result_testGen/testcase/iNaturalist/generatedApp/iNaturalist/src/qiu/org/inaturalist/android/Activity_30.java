...
public class Activity_30 extends Activity
{
	public void launch(){
		...
		//null;;null;;null;;null;;boolean->login->true,boolean->show_skip->true,String->new com.adobe.xmp.properties.XMPPropertyInfo->abcde,String->accountType->abcde,String->authAccount->abcde,Parcelable->com.facebook.LoginFragment:Result->ParcelableObj,
	}
