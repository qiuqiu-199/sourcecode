...
public class Activity_769 extends Activity
{
	public void launch(){
		...
		intent.setAction("get_project_species_result");
		...
		//get_project_species_result;;null;;null;;null;;String->project->999999999999999999999999999999999999999999999999999,Serializable->results->SerializableObj,boolean->is_shared_on_app->false,String->new com.adobe.xmp.properties.XMPPropertyInfo->999999999999999999999999999999999999999999999999999,String->error->abcde,
	}
