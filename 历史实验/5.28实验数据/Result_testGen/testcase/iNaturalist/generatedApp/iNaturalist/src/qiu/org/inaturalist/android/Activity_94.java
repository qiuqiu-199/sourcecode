...
public class Activity_94 extends Activity
{
	public void launch(){
		...
		intent.putExtra("location_expansion", 0.0);
		...
		//null;;null;;null;;null;;Serializable->mission->SerializableObj,Serializable->taxon_result->SerializableObj,float->location_expansion->0.0,String->new com.adobe.xmp.properties.XMPPropertyInfo->999999999999999999999999999999999999999999999999999,String->error->abcde,
	}
