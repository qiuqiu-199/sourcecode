...
public class Activity_756 extends Activity
{
	public void launch(){
		...
		//get_project_identifiers_result;;null;;null;;null;;String->project->abcde,Serializable->results->SerializableObj,boolean->is_shared_on_app->true,String->new com.adobe.xmp.properties.XMPPropertyInfo->abcde,String->error->!@#$%^ds:+_,
	}
