...
public class Activity_75 extends Activity
{
	public void launch(){
		...
		//null;;null;;null;;null;;String->path->abcde,Serializable->comment->SerializableObj,Serializable->parent->SerializableObj,String->xsrf->abcde,String->giveaway->abcde,String->title->abcde,
	}
