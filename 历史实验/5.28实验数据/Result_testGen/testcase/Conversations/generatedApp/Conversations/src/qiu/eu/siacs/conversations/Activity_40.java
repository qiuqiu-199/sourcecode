...
public class Activity_40 extends Activity
{
	public void launch(){
		...
		//null;;null;;null;;null;;String->body->!@#$%^ds:+_,String->contact->999999999999999999999999999999999999999999999999999,int->result_code->Integer.MAX_VALUE,Parcelable->intent->ParcelableObj,Parcelable->metadata->ParcelableObj,
	}
