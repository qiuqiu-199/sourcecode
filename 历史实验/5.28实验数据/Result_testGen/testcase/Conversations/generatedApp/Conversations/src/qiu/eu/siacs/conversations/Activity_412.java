...
public class Activity_412 extends Activity
{
	public void launch(){
		...
		//eu.siacs.conversations.location.show, android.intent.action.VIEW;;null;;https://maps.google.com/maps?q=loc:,, geo:,?q=,();;null;;double->latitude->Double.MAX_VALUE,String->jid->999999999999999999999999999999999999999999999999999,String->name->!@#$%^ds:+_,double->longitude->Double.MAX_VALUE,
	}
