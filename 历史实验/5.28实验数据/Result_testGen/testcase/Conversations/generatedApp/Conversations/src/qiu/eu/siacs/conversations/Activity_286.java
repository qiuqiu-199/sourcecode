...
public class Activity_286 extends Activity
{
	public void launch(){
		...
		//eu.siacs.conversations.action.VIEW;;null;;null;;null;;String->android.intent.extra.TEXT->abcde,String->conversationUuid->abcde,boolean->do_not_append->false,boolean->pm->true,String->nick->abcde,
	}
