...
public class Activity_38 extends Activity
{
	public void launch(){
		...
		//null;;null;;null;;null;;String->body->abcde,String->contact->abcde,int->result_code->Integer.MAX_VALUE,Parcelable->intent->ParcelableObj,Parcelable->metadata->ParcelableObj,
	}
