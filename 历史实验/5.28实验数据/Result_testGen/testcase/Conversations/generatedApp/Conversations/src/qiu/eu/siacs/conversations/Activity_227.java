...
public class Activity_227 extends Activity
{
	public void launch(){
		...
		//eu.siacs.conversations.action.VIEW;;null;;null;;null;;String->android.intent.extra.TEXT->abcde,String->conversationUuid->999999999999999999999999999999999999999999999999999,boolean->do_not_append->true,boolean->pm->false,boolean->as_quote->false,String->nick->!@#$%^ds:+_,
	}
