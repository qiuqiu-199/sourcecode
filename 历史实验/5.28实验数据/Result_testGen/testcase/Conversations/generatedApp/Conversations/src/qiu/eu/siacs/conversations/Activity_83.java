...
public class Activity_83 extends Activity
{
	public void launch(){
		...
		//android.intent.action.SEND_MULTIPLE;;null;;null;;notEmpty;;Parcelable->android.intent.extra.STREAM->ParcelableObj,String->android.intent.extra.TEXT->abcde,int->result_code->0,Parcelable->intent->ParcelableObj,Parcelable->metadata->ParcelableObj,
	}
