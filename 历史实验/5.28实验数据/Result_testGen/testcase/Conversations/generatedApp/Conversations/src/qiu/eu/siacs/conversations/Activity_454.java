...
public class Activity_454 extends Activity
{
	public void launch(){
		...
		//null;;null;;notEmpty;;null;;String->eu.siacs.conversations.invite_uri->abcde,boolean->setup->true,Parcelable->CROP_IMAGE_EXTRA_RESULT->ParcelableObj,String->account->!@#$%^ds:+_,
	}
