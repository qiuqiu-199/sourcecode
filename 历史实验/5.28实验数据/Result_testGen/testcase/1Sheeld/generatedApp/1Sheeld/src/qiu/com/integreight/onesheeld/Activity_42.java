...
public class Activity_42 extends Activity
{
	public void launch(){
		...
		intent.putExtra("com.integreight.onesheeld.extra.PIN_NUMBER", Integer.MAX_VALUE);
		...
		//null;;null;;null;;null;;String->com.twofortyfouram.locale.intent.extra.BREADCRUMB->abcde,boolean->com.integreight.onesheeld.extra.OUTPUT->false,Bundle->com.twofortyfouram.locale.intent.extra.BUNDLE->BundleObj,int->com.integreight.onesheeld.extra.PIN_NUMBER->Integer.MAX_VALUE,
	}
