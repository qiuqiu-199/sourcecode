...
public class Activity_75 extends Activity
{
	public void launch(){
		...
		//android.intent.action.VIEW;;null;;mSheme://mHost:mPort/notEmpty;;null;;String->com.fsck.k9.search_account)->abcde,boolean->override_crypto_warning->false,Bundle->app_data->BundleObj,Parcelable->signature->ParcelableObj,String->special_folder->!@#$%^ds:+_,int->result_code->0,byteArray->search_bytes->0,String->folder->999999999999999999999999999999999999999999999999999,Parcelable->insecure_detail_intent->ParcelableObj,Parcelable->decryption->ParcelableObj,String->query->!@#$%^ds:+_,String->com.fsck.k9.search_folder->abcde,Parcelable->intent->ParcelableObj,boolean->no_threading->true,Parcelable->error->ParcelableObj,String->account->!@#$%^ds:+_,String->message_reference->abcde,
	}
