...
public class Activity_65 extends Activity
{
	public void launch(){
		...
		//shortcut;;null;;mSheme:mAuthority/notEmpty;;null;;String->com.fsck.k9.search_account)->999999999999999999999999999999999999999999999999999,boolean->override_crypto_warning->true,Bundle->app_data->BundleObj,Parcelable->signature->ParcelableObj,String->special_folder->abcde,int->result_code->Integer.MIN_VALUE,byteArray->search_bytes->Byte.MIN_VALUE,String->folder->999999999999999999999999999999999999999999999999999,Parcelable->insecure_detail_intent->ParcelableObj,Parcelable->decryption->ParcelableObj,String->query->!@#$%^ds:+_,String->com.fsck.k9.search_folder->!@#$%^ds:+_,Parcelable->intent->ParcelableObj,boolean->no_threading->true,Parcelable->error->ParcelableObj,String->account->999999999999999999999999999999999999999999999999999,
	}
