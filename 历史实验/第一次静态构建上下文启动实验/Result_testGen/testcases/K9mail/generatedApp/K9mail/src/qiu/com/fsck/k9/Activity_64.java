...
public class Activity_64 extends Activity
{
	public void launch(){
		...
		//shortcut;;null;;mSheme://mHost:mPort/notEmpty;;null;;String->com.fsck.k9.search_account)->abcde,boolean->override_crypto_warning->true,Bundle->app_data->BundleObj,Parcelable->signature->ParcelableObj,String->special_folder->!@#$%^ds:+_,int->result_code->Integer.MIN_VALUE,byteArray->search_bytes->Byte.MAX_VALUE,String->folder->abcde,Parcelable->insecure_detail_intent->ParcelableObj,Parcelable->decryption->ParcelableObj,String->query->abcde,String->com.fsck.k9.search_folder->abcde,Parcelable->intent->ParcelableObj,boolean->no_threading->false,Parcelable->error->ParcelableObj,String->account->!@#$%^ds:+_,String->message_reference->abcde,
	}
