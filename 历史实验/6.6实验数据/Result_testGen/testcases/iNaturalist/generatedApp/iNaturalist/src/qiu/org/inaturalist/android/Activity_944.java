...
public class Activity_944 extends Activity
{
	public void launch(){
		...
		//null;;null;;null;;null;;String->observation->abcde,boolean->show_comments->false,boolean->read_only->true,boolean->scroll_to_comments_bottom->true,boolean->reload->false,
	}
