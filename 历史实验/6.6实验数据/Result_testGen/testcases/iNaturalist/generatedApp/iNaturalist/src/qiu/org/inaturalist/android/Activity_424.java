...
public class Activity_424 extends Activity
{
	public void launch(){
		...
		//null;;null;;null;;null;;String->species_guess->abcde,int->observation_id->Integer.MAX_VALUE,int->observation_id_internal->Integer.MAX_VALUE,String->observation_json->abcde,boolean->show_unknown->false,
	}
