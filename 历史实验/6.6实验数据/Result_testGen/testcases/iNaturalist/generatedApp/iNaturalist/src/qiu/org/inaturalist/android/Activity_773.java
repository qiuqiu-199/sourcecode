...
public class Activity_773 extends Activity
{
	public void launch(){
		...
		//null;;null;;null;;null;;Serializable->longitude->SerializableObj,double->accuracy->Double.MAX_VALUE,Serializable->latitude->SerializableObj,String->iconic_taxon_name->abcde,
	}
