...
public class Activity_124 extends Activity
{
	public void launch(){
		...
		intent.putExtra("location_expansion", Float.MAX_VALUE);
		...
		//null;;null;;null;;null;;Serializable->mission->SerializableObj,Serializable->taxon_result->SerializableObj,float->location_expansion->Float.MAX_VALUE,String->new com.adobe.xmp.properties.XMPPropertyInfo->abcde,String->error->999999999999999999999999999999999999999999999999999,
	}
