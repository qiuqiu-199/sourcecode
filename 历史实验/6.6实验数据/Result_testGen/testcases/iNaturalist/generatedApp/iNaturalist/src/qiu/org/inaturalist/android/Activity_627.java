...
public class Activity_627 extends Activity
{
	public void launch(){
		...
		//null;;null;;null;;null;;boolean->download_taxon->false,Serializable->taxon_result->SerializableObj,boolean->show_add->false,String->taxon_id->abcde,boolean->guide_taxon->true,String->guide_id->!@#$%^ds:+_,String->new com.adobe.xmp.properties.XMPPropertyInfo->abcde,String->guide_xml_filename->999999999999999999999999999999999999999999999999999,Serializable->taxon->SerializableObj,
	}
