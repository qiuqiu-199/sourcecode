...
public class Activity_210 extends Activity
{
	public void launch(){
		...
		//explore_get_species_result;;null;;null;;null;;Serializable->results->SerializableObj,boolean->is_shared_on_app->false,int->active_tab->Integer.MAX_VALUE,String->new com.adobe.xmp.properties.XMPPropertyInfo->!@#$%^ds:+_,String->error->abcde,Serializable->search_filters->SerializableObj,
	}
