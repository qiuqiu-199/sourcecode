...
public class Activity_86 extends Activity
{
	public void launch(){
		...
		//null;;null;;null;;null;;String->obs_photo_filename->!@#$%^ds:+_,double->latitude->0.0,int->observation_id->0,int->observation_id_internal->Integer.MAX_VALUE,double->longitude->0.0,Serializable->observed_on->SerializableObj,String->obs_photo_url->999999999999999999999999999999999999999999999999999,
	}
