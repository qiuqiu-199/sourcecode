...
public class Activity_1017 extends Activity
{
	public void launch(){
		...
		//null;;null;;null;;null;;String->search_hint_text->abcde,boolean->is_user->false,String->search_url->!@#$%^ds:+_,String->result_viewer_activity_param_name->999999999999999999999999999999999999999999999999999,boolean->return_result->false,String->new com.adobe.xmp.properties.XMPPropertyInfo->abcde,Serializable->result_viewer_activity->SerializableObj,
	}
