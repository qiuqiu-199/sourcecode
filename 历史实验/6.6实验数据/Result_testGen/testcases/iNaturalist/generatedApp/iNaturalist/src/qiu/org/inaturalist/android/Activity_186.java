...
public class Activity_186 extends Activity
{
	public void launch(){
		...
		//explore_get_observations_result;;null;;null;;null;;Serializable->results->SerializableObj,boolean->is_shared_on_app->true,int->active_tab->0,String->new com.adobe.xmp.properties.XMPPropertyInfo->999999999999999999999999999999999999999999999999999,String->error->!@#$%^ds:+_,Serializable->search_filters->SerializableObj,
	}
