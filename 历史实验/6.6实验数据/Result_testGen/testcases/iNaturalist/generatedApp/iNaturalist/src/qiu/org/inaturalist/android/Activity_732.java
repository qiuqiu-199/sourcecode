...
public class Activity_732 extends Activity
{
	public void launch(){
		...
		//?;;null;;null;;null;;int->observation_id->0,int->observation_id_internal->Integer.MAX_VALUE,Serializable->taxon_result->SerializableObj,int->suggestion_index->0,boolean->is_shared_on_app->false,String->observation_json->abcde,String->new com.adobe.xmp.properties.XMPPropertyInfo->999999999999999999999999999999999999999999999999999,
	}
