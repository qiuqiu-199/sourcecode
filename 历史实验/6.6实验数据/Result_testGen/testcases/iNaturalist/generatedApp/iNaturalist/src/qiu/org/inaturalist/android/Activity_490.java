...
public class Activity_490 extends Activity
{
	public void launch(){
		...
		//null;;null;;null;;null;;String->observation->abcde,boolean->is_new_observation->false,int->observation_id->Integer.MIN_VALUE,int->observation_id_internal->Integer.MIN_VALUE,int->current_photo_index->0,boolean->read_only->false,String->new com.adobe.xmp.properties.XMPPropertyInfo->999999999999999999999999999999999999999999999999999,boolean->is_taxon->false,
	}
