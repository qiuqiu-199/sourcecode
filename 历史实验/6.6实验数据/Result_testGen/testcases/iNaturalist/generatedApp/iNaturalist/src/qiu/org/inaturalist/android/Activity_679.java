...
public class Activity_679 extends Activity
{
	public void launch(){
		...
		//FacebookDialogFragment;;null;;null;;null;;Parcelable->content->ParcelableObj,int->com.facebook.platform.protocol.PROTOCOL_VERSION->Integer.MAX_VALUE,String->com.facebook.platform.protocol.CALL_ID->abcde,Bundle->com.facebook.platform.protocol.BRIDGE_ARGS->BundleObj,(,String->action_id->abcde,),Bundle->com.facebook.platform.protocol.METHOD_ARGS->BundleObj,(,),
	}
