...
public class Activity_907 extends Activity
{
	public void launch(){
		...
		//get_project_observers_result;;null;;null;;null;;String->project->999999999999999999999999999999999999999999999999999,Serializable->results->SerializableObj,boolean->is_shared_on_app->true,String->new com.adobe.xmp.properties.XMPPropertyInfo->999999999999999999999999999999999999999999999999999,String->error->abcde,
	}
