...
public class Activity_869 extends Activity
{
	public void launch(){
		...
		//?;;null;;null;;null;;String->project->abcde,Serializable->results->SerializableObj,boolean->is_shared_on_app->true,String->new com.adobe.xmp.properties.XMPPropertyInfo->abcde,String->error->!@#$%^ds:+_,
	}
