...
public class Activity_929 extends Activity
{
	public void launch(){
		...
		//get_project_identifiers_result;;null;;null;;null;;String->project->999999999999999999999999999999999999999999999999999,Serializable->results->SerializableObj,boolean->is_shared_on_app->true,String->new com.adobe.xmp.properties.XMPPropertyInfo->abcde,String->error->!@#$%^ds:+_,
	}
