...
public class Activity_37 extends Activity
{
	public void launch(){
		...
		//null;;null;;null;;null;;boolean->login->true,boolean->show_skip->false,String->new com.adobe.xmp.properties.XMPPropertyInfo->999999999999999999999999999999999999999999999999999,String->accountType->abcde,String->authAccount->!@#$%^ds:+_,Parcelable->com.facebook.LoginFragment:Result->ParcelableObj,
	}
