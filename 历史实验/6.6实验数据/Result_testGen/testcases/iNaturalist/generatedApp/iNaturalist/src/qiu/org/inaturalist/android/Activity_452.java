...
public class Activity_452 extends Activity
{
	public void launch(){
		...
		//null;;null;;null;;null;;Serializable->observation_id_internal->SerializableObj,String->species_guess->!@#$%^ds:+_,Serializable->observation_id->SerializableObj,String->observation_json->abcde,boolean->show_unknown->false,
	}
