...
public class Activity_117 extends Activity
{
	public void launch(){
		...
		//null;;null;;null;;null;;Serializable->mission->SerializableObj,Serializable->taxon_result->SerializableObj,float->location_expansion->Float.MAX_VALUE,String->new com.adobe.xmp.properties.XMPPropertyInfo->!@#$%^ds:+_,String->error->abcde,
	}
