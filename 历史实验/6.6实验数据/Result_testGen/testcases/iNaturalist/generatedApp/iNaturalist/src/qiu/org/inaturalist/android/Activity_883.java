...
public class Activity_883 extends Activity
{
	public void launch(){
		...
		//get_project_observations_result;;null;;null;;null;;String->project->999999999999999999999999999999999999999999999999999,Serializable->results->SerializableObj,boolean->is_shared_on_app->true,String->new com.adobe.xmp.properties.XMPPropertyInfo->!@#$%^ds:+_,String->error->999999999999999999999999999999999999999999999999999,
	}
