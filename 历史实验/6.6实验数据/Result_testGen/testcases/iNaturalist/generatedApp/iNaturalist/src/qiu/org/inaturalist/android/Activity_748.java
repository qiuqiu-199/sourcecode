...
public class Activity_748 extends Activity
{
	public void launch(){
		...
		//null;;null;;null;;null;;int->observation_id->Integer.MAX_VALUE,int->suggestion_index->Integer.MAX_VALUE,String->observation_json->abcde,
	}
