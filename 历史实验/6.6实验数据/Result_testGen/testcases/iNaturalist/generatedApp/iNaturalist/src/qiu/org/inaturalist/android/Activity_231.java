...
public class Activity_231 extends Activity
{
	public void launch(){
		...
		//explore_get_observers_result;;null;;null;;null;;Serializable->results->SerializableObj,boolean->is_shared_on_app->false,int->active_tab->0,String->new com.adobe.xmp.properties.XMPPropertyInfo->abcde,String->error->!@#$%^ds:+_,Serializable->search_filters->SerializableObj,
	}
