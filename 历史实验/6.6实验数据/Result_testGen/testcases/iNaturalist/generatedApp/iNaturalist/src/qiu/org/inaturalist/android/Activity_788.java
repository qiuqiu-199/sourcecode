...
public class Activity_788 extends Activity
{
	public void launch(){
		...
		//.action_refresh;;null;;null;;null;;Bundle->.extra_params->BundleObj,(,),String->.extra_url->!@#$%^ds:+_,String->.extra_chromePackage->abcde,
	}
