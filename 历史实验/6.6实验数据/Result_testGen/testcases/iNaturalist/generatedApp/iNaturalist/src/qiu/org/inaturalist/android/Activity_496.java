...
public class Activity_496 extends Activity
{
	public void launch(){
		...
		//null;;null;;null;;null;;boolean->is_new_observation->true,int->observation_id->0,int->observation_id_internal->0,int->current_photo_index->0,boolean->read_only->true,
	}
