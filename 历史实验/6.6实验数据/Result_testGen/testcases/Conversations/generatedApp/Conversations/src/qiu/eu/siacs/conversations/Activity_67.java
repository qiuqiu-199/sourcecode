...
public class Activity_67 extends Activity
{
	public void launch(){
		...
		//null;;null;;null;;null;;boolean->extra_show_enter_jid->true,String->extra_conversation->abcde,String[]->extra_filtered_contacts->abcde,boolean->extra_select_multiple->false,String->account->abcde,
	}
