...
public class Activity_267 extends Activity
{
	public void launch(){
		...
		//eu.siacs.conversations.action.VIEW;;null;;null;;null;;String->android.intent.extra.TEXT->999999999999999999999999999999999999999999999999999,String->conversationUuid->abcde,boolean->do_not_append->true,boolean->pm->false,String->nick->abcde,
	}
