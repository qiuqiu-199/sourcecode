...
public class Activity_270 extends Activity
{
	public void launch(){
		...
		//eu.siacs.conversations.action.VIEW;;null;;null;;null;;String->android.intent.extra.TEXT->999999999999999999999999999999999999999999999999999,String->conversationUuid->!@#$%^ds:+_,boolean->do_not_append->false,boolean->pm->true,String->nick->!@#$%^ds:+_,
	}
