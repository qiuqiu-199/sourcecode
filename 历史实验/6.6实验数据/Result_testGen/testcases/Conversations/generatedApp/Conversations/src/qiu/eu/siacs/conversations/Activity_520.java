...
public class Activity_520 extends Activity
{
	public void launch(){
		...
		//eu.siacs.conversations.location.show, android.intent.action.VIEW;;null;;https://maps.google.com/maps?q=loc:,, geo:,?q=,();;null;;double->latitude->0.0,String->jid->abcde,String->name->!@#$%^ds:+_,double->longitude->Double.MIN_VALUE,
	}
