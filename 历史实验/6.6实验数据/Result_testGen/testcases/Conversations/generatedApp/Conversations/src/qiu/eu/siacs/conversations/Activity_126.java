...
public class Activity_126 extends Activity
{
	public void launch(){
		...
		//android.intent.action.SEND;;null;;null;;?;;Parcelable->android.intent.extra.STREAM->ParcelableObj,String->android.intent.extra.TEXT->abcde,int->result_code->0,Parcelable->intent->ParcelableObj,Parcelable->metadata->ParcelableObj,
	}
