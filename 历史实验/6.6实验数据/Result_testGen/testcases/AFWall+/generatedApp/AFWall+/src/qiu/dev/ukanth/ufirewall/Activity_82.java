...
public class Activity_82 extends Activity
{
	public void launch(){
		...
		com_dot_twofortyfouram_dot_locale_dot_intent_dot_extra_dot_BUNDLE1.putString("dev.ukanth.ufirewall.plugin.APPLY_PROFILE", "!@#$%^ds:+_");
		...
		//null;;null;;null;;null;;Bundle->com.twofortyfouram.locale.intent.extra.BUNDLE1->BundleObj,(,String->dev.ukanth.ufirewall.plugin.APPLY_PROFILE->!@#$%^ds:+_,),Bundle->com.twofortyfouram.locale.intent.extra.BUNDLE1->BundleObj,(,),
	}
