...
public class Activity_268 extends Activity
{
	public void launch(){
		...
		//android.intent.action.SEND;;null;;null;;null;;String->CONTENTS->999999999999999999999999999999999999999999999999999,int->edit.field.result.field.index->Integer.MAX_VALUE,int->CALLER->Integer.MIN_VALUE,String->ID->!@#$%^ds:+_,String->edit.field.result.field->abcde,
	}
