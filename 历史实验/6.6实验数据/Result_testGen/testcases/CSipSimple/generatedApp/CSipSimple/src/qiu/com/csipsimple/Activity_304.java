...
public class Activity_304 extends Activity
{
	public void launch(){
		...
		//com.csipsimple.service.MEDIA_CHANGED;;null;;null;;null;;long->id->0,String->android.intent.extra.PHONE_NUMBER->999999999999999999999999999999999999999999999999999,int->call_id->Integer.MIN_VALUE,int->android.intent.extra.UID->Integer.MAX_VALUE,String->android.intent.extra.SUBJECT->abcde,Parcelable->call_info->ParcelableObj,
	}
