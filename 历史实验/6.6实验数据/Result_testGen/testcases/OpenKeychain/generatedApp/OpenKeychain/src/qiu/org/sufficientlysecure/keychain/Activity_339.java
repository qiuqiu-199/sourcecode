...
public class Activity_339 extends Activity
{
	public void launch(){
		...
		//org.sufficientlysecure.keychain.action.IMPORT_KEY_FROM_QR_CODE;;null;;?;;null;;Parcelable->result_data->ParcelableObj,String->SCAN_RESULT_FORMAT->!@#$%^ds:+_,String->SCAN_RESULT->abcde,int->SCAN_RESULT_ORIENTATION->Integer.MIN_VALUE,Parcelable->operation_result->ParcelableObj,byteArray->SCAN_RESULT_BYTES->0,ParcelableArray->android.nfc.extra.NDEF_MESSAGES->ParcelableArrayObj,String->SCAN_RESULT_ERROR_CORRECTION_LEVEL->!@#$%^ds:+_,Parcelable->result_crypto_input->ParcelableObj,String->SCAN_RESULT_IMAGE_PATH->!@#$%^ds:+_,
	}
