...
public class Activity_482 extends Activity
{
	public void launch(){
		...
		//android.nfc.action.NDEF_DISCOVERED;;null;;null;;null;;boolean->create_yubi_key->false,Parcelable->token_info->ParcelableObj,String->name->!@#$%^ds:+_,boolean->first_time->true,Parcelable->android.nfc.extra.TAG->ParcelableObj,String->email->999999999999999999999999999999999999999999999999999,
	}
