...
public class Activity_34 extends Activity
{
	public void launch(){
		...
		//FacebookDialogFragment;;null;;null;;null;;int->com.facebook.platform.protocol.PROTOCOL_VERSION->Integer.MAX_VALUE,Bundle->com.facebook.platform.protocol.BRIDGE_ARGS->BundleObj,(,String->action_id->!@#$%^ds:+_,),String->com.facebook.platform.protocol.CALL_ID->!@#$%^ds:+_,Bundle->com.facebook.platform.protocol.METHOD_ARGS->BundleObj,(,),
	}
