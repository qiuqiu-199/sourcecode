...
public class Activity_237 extends Activity
{
	public void launch(){
		...
		Bundle alarm_params = new Bundle();
		Parcelable alarm_params1 = new MyParcelable();
		alarm_params.putParcelable("alarm_params1", alarm_params1);
		...
		//null;;null;;null;;null;;String->date->999999999999999999999999999999999999999999999999999,Parcelable->target->ParcelableObj,int->action->Integer.MIN_VALUE,String->schedule_time->999999999999999999999999999999999999999999999999999,Bundle->alarm_params->BundleObj,(,Parcelable->alarm_params1->ParcelableObj,),Serializable->schedule_id->SerializableObj,
	}
