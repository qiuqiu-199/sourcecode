...
public class Activity_62 extends Activity
{
	public void launch(){
		...
		//android.intent.action.VIEW;;null;;mSheme://mHost:mPort/?;;null;;boolean->override_crypto_warning->true,Parcelable->signature->ParcelableObj,String->special_folder->abcde,int->result_code->Integer.MIN_VALUE,byteArray->search_bytes->Byte.MAX_VALUE,String->folder->!@#$%^ds:+_,Bundle->app_data->BundleObj,(,String->com.fsck.k9.search_account->999999999999999999999999999999999999999999999999999,String->com.fsck.k9.search_folder->!@#$%^ds:+_,),Parcelable->insecure_detail_intent->ParcelableObj,Parcelable->decryption->ParcelableObj,String->query->abcde,Parcelable->intent->ParcelableObj,boolean->no_threading->true,Parcelable->error->ParcelableObj,String->account->abcde,String->message_reference->abcde,
	}
