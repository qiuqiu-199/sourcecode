...
public class Activity_43 extends Activity
{
	public void launch(){
		...
		//shortcut;;null;;mSheme:mAuthority/notEmpty;;null;;String->com.fsck.k9.search_account)->999999999999999999999999999999999999999999999999999,boolean->override_crypto_warning->false,Bundle->app_data->BundleObj,Parcelable->signature->ParcelableObj,String->special_folder->abcde,int->result_code->Integer.MIN_VALUE,byteArray->search_bytes->Byte.MAX_VALUE,String->folder->abcde,Parcelable->insecure_detail_intent->ParcelableObj,Parcelable->decryption->ParcelableObj,String->query->!@#$%^ds:+_,String->com.fsck.k9.search_folder->abcde,Parcelable->intent->ParcelableObj,boolean->no_threading->false,Parcelable->error->ParcelableObj,String->account->!@#$%^ds:+_,
	}
