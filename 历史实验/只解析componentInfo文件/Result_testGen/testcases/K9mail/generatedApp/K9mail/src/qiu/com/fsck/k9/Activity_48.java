...
public class Activity_48 extends Activity
{
	public void launch(){
		...
		//android.intent.action.VIEW;;null;;notEmpty;;null;;String->com.fsck.k9.search_account)->!@#$%^ds:+_,boolean->override_crypto_warning->true,Bundle->app_data->BundleObj,Parcelable->signature->ParcelableObj,String->special_folder->abcde,int->result_code->0,byteArray->search_bytes->0,String->folder->999999999999999999999999999999999999999999999999999,Parcelable->insecure_detail_intent->ParcelableObj,Parcelable->decryption->ParcelableObj,String->query->999999999999999999999999999999999999999999999999999,String->com.fsck.k9.search_folder->!@#$%^ds:+_,Parcelable->intent->ParcelableObj,boolean->no_threading->true,Parcelable->error->ParcelableObj,String->account->999999999999999999999999999999999999999999999999999,
	}
