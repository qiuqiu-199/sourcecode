...
public class Activity_55 extends Activity
{
	public void launch(){
		...
		intent.putExtra("com.nutomic.syncthingandroid.activities.FolderActivity.IS_CREATE", false);
		intent.putExtra("com.nutomic.syncthingandroid.activities.FolderActivity.FOLDER_ID", "tas-al00_y8vx-照片");
		startActivity(intent);
		//null;;null;;?;;null;;String->com.nutomic.syncthingandroid.activities.FolderActivity.FOLDER_ID->tas-al00_y8vx-照片,boolean->com.nutomic.syncthingandroid.activities.FolderActivity.IS_CREATE->false,String->com.nutomic.syncthinandroid.activities.PullOrderDialogActivity.EXTRA_RESULT_PULL_ORDER->abcde,int->com.nutomic.syncthingandroid.activities.FolderActivity.NOTIFICATION_ID->0,String->com.nutomic.syncthinandroid.activities.FolderTypeDialogActivity.EXTRA_RESULT_FOLDER_TYPE->abcde,String->com.nutomic.syncthingandroid.activities.FolderActivity.DEVICE_ID->abcde,String->com.nutomic.syncthingandroid.activities.FolderActivity.FOLDER_LABEL->abcde,String->com.nutomic.syncthingandroid.activities.FolderPickerActivity.RESULT_DIRECTORY->abcde,
	}
