...
public class Activity_73 extends Activity
{
	public void launch(){
		...
		//null;;null;;null;;null;;Serializable->mission->SerializableObj,Serializable->taxon_result->SerializableObj,float->location_expansion->0.0,String->new com.adobe.xmp.properties.XMPPropertyInfo->abcde,String->error->abcde,
	}
