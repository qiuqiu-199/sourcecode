...
public class Activity_284 extends Activity
{
	public void launch(){
		...
		//get_project_observers_result;;null;;null;;null;;String->project->abcde,Serializable->results->SerializableObj,boolean->is_shared_on_app->false,String->new com.adobe.xmp.properties.XMPPropertyInfo->abcde,String->error->abcde,
	}
