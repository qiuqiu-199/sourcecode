...
public class Activity_205 extends Activity
{
	public void launch(){
		...
		//null;;null;;null;;null;;boolean->download_taxon->true,Serializable->taxon_result->SerializableObj,boolean->show_add->true,String->taxon_id->abcde,boolean->guide_taxon->false,String->guide_id->abcde,String->new com.adobe.xmp.properties.XMPPropertyInfo->abcde,String->guide_xml_filename->abcde,Serializable->taxon->SerializableObj,
	}
