...
public class Activity_314 extends Activity
{
	public void launch(){
		...
		//android.nfc.action.NDEF_DISCOVERED;;null;;null;;null;;Parcelable->token_info->ParcelableObj,String->name->null,Parcelable->android.nfc.extra.TAG->ParcelableObj,boolean->first_time->false,boolean->create_yubi_key->false,String->email->null,
	}
