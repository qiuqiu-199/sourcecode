...
public class Activity_145 extends Activity
{
	public void launch(){
		...
		intent.putExtra("MedicinesActivity.extras.SEARCH_TEXT", "abcde");
		intent.putExtra("medicine_id", 0);
		startActivity(intent);
		//null;;null;;null;;null;;long->medicine_id->0,String->MedicinesActivity.extras.SEARCH_TEXT->abcde,String->qr_data->abcde,String->MedicineSearchActivity.return.extras.PRESCRIPTION_NAME->abcde,Parcelable->MedicineSearchActivity.return.extras.PRESCRIPTION->ParcelableObj,String->action->abcde,
	}
