...
public class Activity_17 extends Activity
{
	public void launch(){
		...
		//null;;null;;null;;null;;Serializable->comment->SerializableObj,Serializable->edited->SerializableObj,Serializable->uuid->SerializableObj,Serializable->whitelist->SerializableObj,String->close->null,Serializable->notifications->SerializableObj,Serializable->discussion->SerializableObj,Serializable->giveaway->SerializableObj,String->user->Sueudo,boolean->entered->false,
	}
