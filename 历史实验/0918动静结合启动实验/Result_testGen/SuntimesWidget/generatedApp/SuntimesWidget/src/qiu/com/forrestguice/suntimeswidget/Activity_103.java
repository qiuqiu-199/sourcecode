...
public class Activity_103 extends Activity
{
	public void launch(){
		...
		intent.putExtra("selectedAlarm", -1);
		...
		//com.forrestguice.suntimeswidget.alarmclock.ADD_ALARM;;null;;?;;null;;IntegerArrayList->android.intent.extra.alarm.DAYS->0,String->solarevent->abcde,boolean->showBack->false,int->android.intent.extra.alarm.HOUR->0,long->selectedAlarm->-1,String->android.intent.extra.alarm.RINGTONE->abcde,int->android.intent.extra.alarm.MINUTES->0,String->android.intent.extra.alarm.MESSAGE->abcde,Parcelable->android.intent.extra.ringtone.PICKED_URI->ParcelableObj,boolean->android.intent.extra.alarm.VIBRATE->true,
	}
