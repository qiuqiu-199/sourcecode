...
public class Activity_89 extends Activity
{
	public void launch(){
		...
		//null;;null;;x-oauthflow-opengpstracker://mHost:mPort/mPath;;null;;String->OAUTH_TOKEN_SECRET->abcde,String->CONSUMER_KEY->abcde,String->REQUEST_URL->abcde,String->OAUTH_TOKEN->abcde,String->AUTHORIZE_URL->abcde,String->ACCESS_URL->abcde,String->CONSUMER_SECRET->abcde,
	}
