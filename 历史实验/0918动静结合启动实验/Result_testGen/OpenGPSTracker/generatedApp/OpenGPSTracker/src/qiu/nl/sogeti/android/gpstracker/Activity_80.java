...
public class Activity_80 extends Activity
{
	public void launch(){
		...
		//null;;null;;?;;null;;String->OAUTH_TOKEN_SECRET->abcde,String->CONSUMER_KEY->abcde,String->REQUEST_URL->abcde,String->OAUTH_TOKEN->abcde,String->AUTHORIZE_URL->abcde,String->ACCESS_URL->abcde,String->CONSUMER_SECRET->abcde,
	}
