...
public class Activity_228 extends Activity
{
	public void launch(){
		...
		//com.csipsimple.service.MEDIA_CHANGED;;null;;null;;null;;long->id->0,String->android.intent.extra.PHONE_NUMBER->abcde,int->call_id->0,int->android.intent.extra.UID->0,String->android.intent.extra.SUBJECT->abcde,Parcelable->call_info->ParcelableObj,
	}
