...
public class Activity_179 extends Activity
{
	public void launch(){
		...
		//android.intent.action.SEND;;null;;null;;null;;String->CONTENTS->abcde,int->edit.field.result.field.index->0,int->CALLER->0,String->ID->abcde,String->edit.field.result.field->abcde,
	}
