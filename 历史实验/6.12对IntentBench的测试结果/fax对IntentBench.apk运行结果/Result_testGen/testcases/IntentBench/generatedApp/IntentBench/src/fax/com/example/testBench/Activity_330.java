...
public class Activity_330 extends Activity
{
	public void launch(){
		...
		intent.putExtra("long_d", Long.MAX_VALUE);
		intent.putExtra("double_b", 0.0);
		startActivity(intent);
		//null;;null;;null;;null;;double->double_b->0.0,long->long_d->Long.MAX_VALUE,short->short_e->Short.MIN_VALUE,float->float_c->Float.MAX_VALUE,
	}
