...
public class Activity_299 extends Activity
{
	public void launch(){
		...
		//null;;null;;null;;null;;shortArray->short_arr->0.0,intArray->int_arr->0,StringArray->str_arr->abcde,floatArray->float_arr->Float.MIN_VALUE,doubleArray->double_arr->Double.MAX_VALUE,longArray->long_arr->0,
	}
