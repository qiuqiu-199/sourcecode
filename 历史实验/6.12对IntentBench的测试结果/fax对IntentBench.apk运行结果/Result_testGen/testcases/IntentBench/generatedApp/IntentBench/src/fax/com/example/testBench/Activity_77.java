...
public class Activity_77 extends Activity
{
	public void launch(){
		...
		//null;;null;;null;;null;;charArray->ch_arr->\\,CharSequenceArrayList->charseq_arr_list->!@#$%^ds:+_,byteArray->bt_arr->0,IntegerArrayList->int_arrlist->0,StringArrayList->str_arrlist->!@#$%^ds:+_,CharSequenceArray->charseq_arr->!@#$%^ds:+_,
	}
