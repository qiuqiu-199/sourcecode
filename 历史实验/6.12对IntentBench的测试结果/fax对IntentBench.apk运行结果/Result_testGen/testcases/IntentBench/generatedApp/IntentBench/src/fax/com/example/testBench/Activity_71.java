...
public class Activity_71 extends Activity
{
	public void launch(){
		...
		//null;;null;;null;;null;;charArray->ch_arr->\\,CharSequenceArrayList->charseq_arr_list->abcde,IntegerArrayList->int_arrlist->0,StringArrayList->str_arrlist->!@#$%^ds:+_,CharSequence->charseq->abcde,CharSequenceArray->charseq_arr->999999999999999999999999999999999999999999999999999,
	}
