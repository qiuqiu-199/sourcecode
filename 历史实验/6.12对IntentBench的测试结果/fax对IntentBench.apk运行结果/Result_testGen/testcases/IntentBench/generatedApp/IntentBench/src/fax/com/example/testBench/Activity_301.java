...
public class Activity_301 extends Activity
{
	public void launch(){
		...
		//null;;null;;null;;null;;shortArray->short_arr->Short.MIN_VALUE,intArray->int_arr->0,StringArray->str_arr->!@#$%^ds:+_,doubleArray->double_arr->0.0,booleanArray->bool_arr->false,longArray->long_arr->0,
	}
