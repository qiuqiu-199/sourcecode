...
public class Activity_302 extends Activity
{
	public void launch(){
		...
		//null;;null;;null;;null;;shortArray->short_arr->0.0,intArray->int_arr->Integer.MAX_VALUE,floatArray->float_arr->Float.MIN_VALUE,doubleArray->double_arr->Double.MIN_VALUE,booleanArray->bool_arr->true,longArray->long_arr->0,
	}
