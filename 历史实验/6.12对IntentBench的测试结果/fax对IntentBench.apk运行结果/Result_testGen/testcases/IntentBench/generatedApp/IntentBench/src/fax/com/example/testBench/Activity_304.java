...
public class Activity_304 extends Activity
{
	public void launch(){
		...
		//null;;null;;null;;null;;shortArray->short_arr->0.0,StringArray->str_arr->abcde,floatArray->float_arr->0.0,doubleArray->double_arr->0.0,booleanArray->bool_arr->true,longArray->long_arr->0,
	}
