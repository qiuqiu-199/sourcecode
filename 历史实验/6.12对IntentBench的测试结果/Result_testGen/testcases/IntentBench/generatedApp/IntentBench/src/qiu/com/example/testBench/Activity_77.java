...
public class Activity_77 extends Activity
{
	public void launch(){
		...
		//null;;null;;null;;null;;byteArray->bt_arr->0,CharSequenceArray->charseq_arr->abcde,StringArrayList->str_arrlist->abcde,CharSequence->charseq->abcde,CharSequenceArrayList->charseq_arr_list->abcde,IntegerArrayList->int_arrlist->0,charArray->ch_arr->a,
	}
