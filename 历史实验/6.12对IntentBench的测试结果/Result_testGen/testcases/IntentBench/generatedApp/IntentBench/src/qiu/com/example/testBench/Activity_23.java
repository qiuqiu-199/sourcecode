...
public class Activity_23 extends Activity
{
	public void launch(){
		...
		MySerializable ser = new MySerializable();
		...
		//null;;null;;null;;null;;ParcelableArrayList->parce_arr_list->ParcelableArrayListObj,Serializable->ser->SerializableObj,ParcelableArray->parce_arr->ParcelableArrayObj,Parcelable->parce->ParcelableObj,
	}
