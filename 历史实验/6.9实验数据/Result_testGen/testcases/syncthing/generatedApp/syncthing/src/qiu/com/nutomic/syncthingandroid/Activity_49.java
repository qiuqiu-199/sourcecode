...
public class Activity_49 extends Activity
{
	public void launch(){
		...
		intent.putExtra("com.nutomic.syncthingandroid.activities.DeviceActivity.DEVICE_ID", "abcde");
		...
		intent.putExtra("com.nutomic.syncthingandroid.activities.DeviceActivity.IS_CREATE", false);
		...
		//null;;null;;null;;null;;String->SCAN_RESULT_FORMAT->abcde,int->com.nutomic.syncthingandroid.activities.DeviceActivity.NOTIFICATION_ID->0,String->SCAN_RESULT->abcde,int->SCAN_RESULT_ORIENTATION->0,boolean->com.nutomic.syncthingandroid.activities.DeviceActivity.IS_CREATE->false,byteArray->SCAN_RESULT_BYTES->0,String->SCAN_RESULT_ERROR_CORRECTION_LEVEL->abcde,String->com.nutomic.syncthingandroid.activities.DeviceActivity.DEVICE_ID->abcde,String->com.nutomic.syncthingandroid.activities.DeviceActivity.DEVICE_NAME->abcde,
	}
