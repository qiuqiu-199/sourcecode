...
public class Activity_6 extends Activity
{
	public void launch(){
		...
		//null;;null;;null;;null;;long->sign_key_id->0,StringArray->contacts->abcde,String->extra_conversation->abcde,String->contact->abcde,boolean->extra_select_multiple->true,int->result_code->0,Parcelable->intent->ParcelableObj,Parcelable->metadata->ParcelableObj,Parcelable->error->ParcelableObj,
	}
