...
public class Activity_94 extends Activity
{
	public void launch(){
		...
		//android.intent.action.VIEW;;null;;?;;null;;String->extra_conversation->abcde,String->eu.siacs.conversations.invite_uri->abcde,StringArray->contacts->abcde,String->extra_group_chat_name->abcde,boolean->scanned->true,String->contact->abcde,boolean->extra_select_multiple->false,int->result_code->0,Parcelable->intent->ParcelableObj,Parcelable->metadata->ParcelableObj,String->account->abcde,
	}
