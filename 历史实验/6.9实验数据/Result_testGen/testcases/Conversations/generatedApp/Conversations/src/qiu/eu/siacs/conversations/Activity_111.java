...
public class Activity_111 extends Activity
{
	public void launch(){
		...
		//null;;null;;null;;null;;String->extra_conversation->abcde,String->eu.siacs.conversations.invite_uri->abcde,StringArray->contacts->abcde,String->contact->abcde,boolean->extra_select_multiple->false,int->result_code->0,Parcelable->intent->ParcelableObj,Parcelable->metadata->ParcelableObj,Parcelable->error->ParcelableObj,String->result->abcde,
	}
