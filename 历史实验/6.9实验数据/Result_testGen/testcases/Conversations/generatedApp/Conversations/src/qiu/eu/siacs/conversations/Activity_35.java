...
public class Activity_35 extends Activity
{
	public void launch(){
		...
		//null;;null;;null;;null;;boolean->extra_show_enter_jid->true,String->extra_group_chat_name->abcde,boolean->extra_select_multiple->true,int->extra_title_res_id->0,String->account->abcde,
	}
