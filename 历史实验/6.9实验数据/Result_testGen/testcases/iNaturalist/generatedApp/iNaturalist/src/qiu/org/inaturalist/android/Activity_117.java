...
public class Activity_117 extends Activity
{
	public void launch(){
		...
		//null;;null;;null;;null;;Serializable->observation_id_internal->SerializableObj,String->observation->abcde,Serializable->longitude->SerializableObj,Serializable->observation_id->SerializableObj,Serializable->latitude->SerializableObj,boolean->suggest_id->true,Serializable->observed_on->SerializableObj,
	}
