...
public class Activity_44 extends Activity
{
	public void launch(){
		...
		//null;;null;;null;;null;;boolean->signup->false,String->new com.adobe.xmp.properties.XMPPropertyInfo->abcde,String->accountType->abcde,int->background_id->0,String->error->abcde,String->authAccount->abcde,Parcelable->com.facebook.LoginFragment:Result->ParcelableObj,boolean->password_changed->false,boolean->status->false,
	}
