...
public class Activity_303 extends Activity
{
	public void launch(){
		...
		//null;;null;;null;;null;;String->observation->abcde,boolean->show_comments->true,boolean->read_only->false,boolean->scroll_to_comments_bottom->false,boolean->reload->true,
	}
