...
public class Activity_379 extends Activity
{
	public void launch(){
		...
		//null;;null;;null;;null;;Parcelable->result_data->ParcelableObj,String->user_id->abcde,String->package_name->abcde,Parcelable->result_crypto_input->ParcelableObj,boolean->show_autocrypt_hint->true,byteArray->package_signature->0,
	}
