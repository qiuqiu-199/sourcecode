...
public class Activity_5 extends Activity
{
	public void launch(){
		...
		com_dot_twofortyfouram_dot_locale_dot_intent_dot_extra_dot_BUNDLE.putBoolean("com.integreight.condition.extra.OUTPUT", true);
		...
		//null;;null;;null;;null;;String->com.twofortyfouram.locale.intent.extra.BREADCRUMB->abcde,Bundle->com.twofortyfouram.locale.intent.extra.BUNDLE->BundleObj,(,boolean->com.integreight.condition.extra.OUTPUT->true,int->com.integreight.condition.extra.PIN_NUMBER->0,),
	}
