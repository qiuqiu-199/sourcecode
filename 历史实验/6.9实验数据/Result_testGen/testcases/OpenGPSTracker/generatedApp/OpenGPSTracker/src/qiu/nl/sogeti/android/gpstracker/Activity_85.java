...
public class Activity_85 extends Activity
{
	public void launch(){
		...
		//null;;null;;null;;null;;String->CONSUMER_KEY->abcde,String->OAUTH_TOKEN_SECRET->abcde,String->REQUEST_URL->abcde,String->OAUTH_TOKEN->abcde,String->AUTHORIZE_URL->abcde,String->ACCESS_URL->abcde,String->CONSUMER_SECRET->abcde,
	}
