...
public class Activity_93 extends Activity
{
	public void launch(){
		...
		app_data.putString("com.fsck.k9.search_folder", "!@#$%^ds:+_");
		app_data = new Bundle();
		app_data.putString("com.fsck.k9.search_account", "999999999999999999999999999999999999999999999999999");
		...
		//android.intent.action.VIEW;;null;;mSheme:mAuthority/?;;null;;boolean->override_crypto_warning->true,Parcelable->signature->ParcelableObj,String->special_folder->999999999999999999999999999999999999999999999999999,int->result_code->0,byteArray->search_bytes->0,String->folder->999999999999999999999999999999999999999999999999999,Bundle->app_data->BundleObj,(,String->com.fsck.k9.search_account->999999999999999999999999999999999999999999999999999,String->com.fsck.k9.search_folder->!@#$%^ds:+_,),Parcelable->insecure_detail_intent->ParcelableObj,Parcelable->decryption->ParcelableObj,String->query->!@#$%^ds:+_,Parcelable->intent->ParcelableObj,boolean->no_threading->false,Parcelable->error->ParcelableObj,String->account->abcde,String->message_reference->abcde,
	}
