...
public class Activity_133 extends Activity
{
	public void launch(){
		...
		//android.intent.action.SEND;;null;;?;;null;;String->android.intent.extra.TEXT->!@#$%^ds:+_,String->arg.feedurl->999999999999999999999999999999999999999999999999999,String->title->abcde,
	}
