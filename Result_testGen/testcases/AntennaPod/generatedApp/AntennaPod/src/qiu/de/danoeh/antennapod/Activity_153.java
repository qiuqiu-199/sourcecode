...
public class Activity_153 extends Activity
{
	public void launch(){
		...
		//android.intent.action.SEND;;null;;null;;text/plain;;String[]->android.intent.extra.EMAIL->!@#$%^ds:+_,Parcelable->android.intent.extra.STREAM->ParcelableObj,String->android.intent.extra.TEXT->abcde,String->android.intent.extra.SUBJECT->abcde,
	}
