...
public class Activity_141 extends Activity
{
	public void launch(){
		...
		intent.putExtra("arg.feedurl", "!@#$%^ds:+_");
		intent.putExtra("android.intent.extra.TEXT", "abcde");
		startActivity(intent);
		//android.intent.action.VIEW;;null;;?;;null;;String->android.intent.extra.TEXT->abcde,String->arg.feedurl->!@#$%^ds:+_,String->title->999999999999999999999999999999999999999999999999999,
	}
