...
public class Activity_138 extends Activity
{
	public void launch(){
		...
		//android.intent.action.VIEW;;null;;?;;null;;String->android.intent.extra.TEXT->!@#$%^ds:+_,String->arg.feedurl->abcde,String->title->999999999999999999999999999999999999999999999999999,
	}
