...
public class Activity_72 extends Activity
{
	public void launch(){
		...
		//null;;null;;null;;null;;boolean->extra_show_enter_jid->false,String->extra_conversation->abcde,String[]->extra_filtered_contacts->abcde,boolean->extra_select_multiple->true,String->account->abcde,
	}
