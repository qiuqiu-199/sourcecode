...
public class Activity_46 extends Activity
{
	public void launch(){
		...
		//null;;null;;null;;null;;String->body->!@#$%^ds:+_,String->contact->abcde,int->result_code->Integer.MIN_VALUE,Parcelable->intent->ParcelableObj,Parcelable->metadata->ParcelableObj,
	}
