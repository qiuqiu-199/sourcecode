...
public class Activity_100 extends Activity
{
	public void launch(){
		...
		//null;;null;;null;;null;;boolean->extra_show_enter_jid->true,String->extra_group_chat_name->abcde,boolean->extra_select_multiple->false,int->extra_title_res_id->Integer.MIN_VALUE,String->account->abcde,
	}
