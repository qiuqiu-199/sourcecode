...
public class Activity_67 extends Activity
{
	public void launch(){
		...
		//null;;null;;null;;null;;boolean->extra_show_enter_jid->false,String->extra_conversation->!@#$%^ds:+_,String[]->extra_filtered_contacts->!@#$%^ds:+_,boolean->extra_select_multiple->true,String->account->abcde,
	}
