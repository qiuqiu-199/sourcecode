...
public class Activity_204 extends Activity
{
	public void launch(){
		...
		//eu.siacs.conversations.action.VIEW;;null;;null;;null;;String->android.intent.extra.TEXT->!@#$%^ds:+_,String->conversationUuid->999999999999999999999999999999999999999999999999999,boolean->pm->false,boolean->as_quote->false,String->nick->abcde,
	}
