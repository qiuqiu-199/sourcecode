...
public class Activity_414 extends Activity
{
	public void launch(){
		...
		//eu.siacs.conversations.location.show, android.intent.action.VIEW;;null;;https://maps.google.com/maps?q=loc:,, geo:,?q=,();;null;;double->latitude->0.0,String->jid->999999999999999999999999999999999999999999999999999,String->name->!@#$%^ds:+_,double->longitude->0.0,
	}
