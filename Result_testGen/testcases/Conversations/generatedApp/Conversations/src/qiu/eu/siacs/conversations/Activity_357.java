...
public class Activity_357 extends Activity
{
	public void launch(){
		...
		//android.intent.action.SENDTO;;null;;?;;null;;String->extra_conversation->abcde,String->eu.siacs.conversations.invite_uri->abcde,StringArray->contacts->!@#$%^ds:+_,String->extra_group_chat_name->!@#$%^ds:+_,boolean->scanned->true,String->contact->!@#$%^ds:+_,boolean->extra_select_multiple->true,int->result_code->0,Parcelable->intent->ParcelableObj,Parcelable->metadata->ParcelableObj,String->account->abcde,
	}
