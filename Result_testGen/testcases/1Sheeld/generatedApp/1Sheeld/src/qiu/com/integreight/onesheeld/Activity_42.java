...
public class Activity_42 extends Activity
{
	public void launch(){
		...
		//PassThrough;;null;;null;;null;;int->com.facebook.platform.protocol.PROTOCOL_VERSION->Integer.MIN_VALUE,Bundle->com.facebook.platform.protocol.BRIDGE_ARGS->BundleObj,(,String->action_id->abcde,),String->com.facebook.platform.protocol.CALL_ID->abcde,Bundle->com.facebook.platform.protocol.METHOD_ARGS->BundleObj,(,),
	}
