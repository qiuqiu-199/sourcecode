...
public class Activity_30 extends Activity
{
	public void launch(){
		...
		//FacebookDialogFragment;;null;;null;;null;;Bundle->com.facebook.platform.protocol.BRIDGE_ARGS->BundleObj,int->com.facebook.platform.protocol.PROTOCOL_VERSION->Integer.MAX_VALUE,Bundle->com.facebook.platform.protocol.METHOD_ARGS->BundleObj,String->com.facebook.platform.protocol.CALL_ID->!@#$%^ds:+_,String->action_id->999999999999999999999999999999999999999999999999999,
	}
