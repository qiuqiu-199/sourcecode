...
public class Activity_30 extends Activity
{
	public void launch(){
		...
		//FacebookDialogFragment;;null;;null;;null;;int->com.facebook.platform.protocol.PROTOCOL_VERSION->0,Bundle->com.facebook.platform.protocol.BRIDGE_ARGS->BundleObj,(,String->action_id->!@#$%^ds:+_,),String->com.facebook.platform.protocol.CALL_ID->abcde,Bundle->com.facebook.platform.protocol.METHOD_ARGS->BundleObj,(,),
	}
