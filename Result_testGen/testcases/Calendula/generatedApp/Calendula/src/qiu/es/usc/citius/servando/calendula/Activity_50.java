...
public class Activity_50 extends Activity
{
	public void launch(){
		...
		intent.putExtra("patient_id", Long.MIN_VALUE);
		intent.putExtra("qr_data", "999999999999999999999999999999999999999999999999999");
		startActivity(intent);
		//null;;null;;null;;null;;String->qr_data->999999999999999999999999999999999999999999999999999,long->patient_id->Long.MIN_VALUE,
	}
