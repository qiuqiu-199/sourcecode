...
public class Activity_194 extends Activity
{
	public void launch(){
		...
		//null;;null;;null;;null;;String->date->abcde,Bundle->alarm_params->BundleObj,Parcelable->target->ParcelableObj,int->action->0,Serializable->routine_id->SerializableObj,Parcelable->alarm_params->ParcelableObj,
	}
