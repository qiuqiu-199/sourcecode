...
public class Activity_61 extends Activity
{
	public void launch(){
		...
		//null;;null;;null;;null;;String->ABOUT_LIBRARIES_TITLE->abcde,Serializable->ABOUT_COLOR->SerializableObj,int->ABOUT_LIBRARIES_THEME->0,String->ABOUT_LIBRARIES_STYLE->abcde,
	}
