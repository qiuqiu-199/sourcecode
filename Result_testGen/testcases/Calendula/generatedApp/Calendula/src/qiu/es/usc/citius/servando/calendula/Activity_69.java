...
public class Activity_69 extends Activity
{
	public void launch(){
		...
		//null;;null;;null;;null;;int->active_days->0,int->rest_days->Integer.MIN_VALUE,String->start->abcde,String->rule->999999999999999999999999999999999999999999999999999,
	}
