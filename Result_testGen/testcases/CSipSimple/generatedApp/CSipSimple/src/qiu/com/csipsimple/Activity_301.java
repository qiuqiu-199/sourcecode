...
public class Activity_301 extends Activity
{
	public void launch(){
		...
		intent.putExtra("call_id", Integer.MAX_VALUE);
		intent.putExtra("android.intent.extra.PHONE_NUMBER", "abcde");
		intent.putExtra("id", 0);
		startActivity(intent);
		//com.csipsimple.service.SHOW_SAS;;null;;null;;null;;long->id->0,String->android.intent.extra.PHONE_NUMBER->abcde,int->call_id->Integer.MAX_VALUE,int->android.intent.extra.UID->0,String->android.intent.extra.SUBJECT->abcde,Parcelable->call_info->ParcelableObj,
	}
