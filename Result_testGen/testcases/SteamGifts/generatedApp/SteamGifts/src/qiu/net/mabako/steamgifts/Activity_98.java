...
public class Activity_98 extends Activity
{
	public void launch(){
		...
		//null;;null;;null;;null;;String->path->!@#$%^ds:+_,Serializable->comment->SerializableObj,Serializable->parent->SerializableObj,String->xsrf->abcde,String->giveaway->999999999999999999999999999999999999999999999999999,String->title->abcde,
	}
