...
public class Activity_105 extends Activity
{
	public void launch(){
		...
		intent.putExtra("xsrf", "999999999999999999999999999999999999999999999999999");
		MySerializable comment = new MySerializable();
		intent.putExtra("comment", comment);
		startActivity(intent);
		//null;;null;;null;;null;;Serializable->comment->SerializableObj,String->xsrf->999999999999999999999999999999999999999999999999999,CharSequence->title->999999999999999999999999999999999999999999999999999,
	}
