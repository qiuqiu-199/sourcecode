...
public class Activity_107 extends Activity
{
	public void launch(){
		...
		//null;;null;;null;;null;;String->path->!@#$%^ds:+_,Serializable->parent->SerializableObj,String->xsrf->abcde,String->title->999999999999999999999999999999999999999999999999999,
	}
