...
public class Activity_104 extends Activity
{
	public void launch(){
		...
		//null;;null;;x-oauthflow-opengpstracker://mHost:mPort/mPath;;null;;String->OAUTH_TOKEN_SECRET->999999999999999999999999999999999999999999999999999,String->CONSUMER_KEY->abcde,String->OAUTH_TOKEN->abcde,String->REQUEST_URL->abcde,String->AUTHORIZE_URL->999999999999999999999999999999999999999999999999999,String->ACCESS_URL->abcde,String->CONSUMER_SECRET->abcde,
	}
