...
public class Activity_494 extends Activity
{
	public void launch(){
		...
		//null;;null;;null;;null;;boolean->is_new_observation->false,int->observation_id->Integer.MIN_VALUE,int->observation_id_internal->Integer.MIN_VALUE,int->current_photo_index->0,boolean->read_only->true,
	}
