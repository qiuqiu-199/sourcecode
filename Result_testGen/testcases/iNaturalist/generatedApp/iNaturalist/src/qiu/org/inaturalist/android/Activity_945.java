...
public class Activity_945 extends Activity
{
	public void launch(){
		...
		//null;;null;;null;;null;;String->observation->!@#$%^ds:+_,boolean->show_comments->false,boolean->read_only->true,boolean->scroll_to_comments_bottom->false,boolean->reload->true,
	}
