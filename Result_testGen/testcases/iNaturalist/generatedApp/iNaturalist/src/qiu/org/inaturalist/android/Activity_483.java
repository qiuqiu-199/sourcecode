...
public class Activity_483 extends Activity
{
	public void launch(){
		...
		intent.putExtra("current_photo_index", Integer.MAX_VALUE);
		...
		//null;;null;;null;;null;;Serializable->observation_id_internal->SerializableObj,boolean->is_new_observation->false,Serializable->observation_id->SerializableObj,int->current_photo_index->Integer.MAX_VALUE,
	}
