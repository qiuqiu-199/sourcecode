...
public class Activity_889 extends Activity
{
	public void launch(){
		...
		intent.setAction("get_project_observations_result");
		...
		//get_project_observations_result;;null;;null;;null;;String->project->999999999999999999999999999999999999999999999999999,Serializable->results->SerializableObj,boolean->is_shared_on_app->true,String->new com.adobe.xmp.properties.XMPPropertyInfo->abcde,String->error->999999999999999999999999999999999999999999999999999,
	}
