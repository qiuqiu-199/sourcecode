...
public class Activity_88 extends Activity
{
	public void launch(){
		...
		//null;;null;;null;;null;;String->obs_photo_filename->abcde,String->observation->999999999999999999999999999999999999999999999999999,double->latitude->0.0,int->observation_id->0,double->longitude->Double.MAX_VALUE,Serializable->observed_on->SerializableObj,String->obs_photo_url->abcde,
	}
