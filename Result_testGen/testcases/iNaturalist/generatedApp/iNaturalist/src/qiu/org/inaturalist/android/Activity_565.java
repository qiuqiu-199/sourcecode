...
public class Activity_565 extends Activity
{
	public void launch(){
		...
		//?;;null;;null;;null;;Serializable->observations->SerializableObj,Serializable->identifications->SerializableObj,Serializable->user->SerializableObj,String->username->999999999999999999999999999999999999999999999999999,boolean->is_shared_on_app->true,String->new com.adobe.xmp.properties.XMPPropertyInfo->999999999999999999999999999999999999999999999999999,String->error->!@#$%^ds:+_,Serializable->species_count_result->SerializableObj,
	}
