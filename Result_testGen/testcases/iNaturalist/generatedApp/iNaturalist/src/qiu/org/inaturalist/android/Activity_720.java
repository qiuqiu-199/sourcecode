...
public class Activity_720 extends Activity
{
	public void launch(){
		...
		//null;;null;;null;;null;;int->observation_id->Integer.MAX_VALUE,int->observation_id_internal->0,int->suggestion_index->Integer.MIN_VALUE,String->observation_json->abcde,
	}
