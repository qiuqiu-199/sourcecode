...
public class Activity_867 extends Activity
{
	public void launch(){
		...
		//?;;null;;null;;null;;String->project->abcde,Serializable->results->SerializableObj,boolean->is_shared_on_app->false,String->new com.adobe.xmp.properties.XMPPropertyInfo->!@#$%^ds:+_,String->error->abcde,
	}
