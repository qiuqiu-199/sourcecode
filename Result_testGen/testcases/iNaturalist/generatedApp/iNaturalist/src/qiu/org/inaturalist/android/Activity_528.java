...
public class Activity_528 extends Activity
{
	public void launch(){
		...
		//?;;null;;null;;null;;Serializable->results->SerializableObj,Serializable->project->SerializableObj,boolean->is_user_feed->true,boolean->is_shared_on_app->false,String->new com.adobe.xmp.properties.XMPPropertyInfo->abcde,String->error->999999999999999999999999999999999999999999999999999,
	}
