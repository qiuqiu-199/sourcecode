...
public class Activity_21 extends Activity
{
	public void launch(){
		...
		//android.intent.action.SEND;;null;;?;;null;;boolean->from_suggestion->true,double->latitude->0.0,int->taxon_id->Integer.MAX_VALUE,double->accuracy->0.0,Serializable->taxon_result->SerializableObj,IntegerArrayList->project_ids->Integer.MIN_VALUE,String->photoUri->abcde,int->observation_project->0,String->id_name->!@#$%^ds:+_,int->field_id->0,
	}
