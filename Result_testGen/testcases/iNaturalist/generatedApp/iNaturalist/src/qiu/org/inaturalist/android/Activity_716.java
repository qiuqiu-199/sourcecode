...
public class Activity_716 extends Activity
{
	public void launch(){
		...
		//null;;null;;null;;null;;int->observation_id->Integer.MAX_VALUE,int->observation_id_internal->Integer.MIN_VALUE,int->suggestion_index->0,String->observation_json->abcde,
	}
