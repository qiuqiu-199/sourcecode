...
public class Activity_47 extends Activity
{
	public void launch(){
		...
		//null;;null;;null;;null;;boolean->login->false,boolean->show_skip->false,String->new com.adobe.xmp.properties.XMPPropertyInfo->abcde,String->accountType->abcde,String->authAccount->!@#$%^ds:+_,Parcelable->com.facebook.LoginFragment:Result->ParcelableObj,
	}
