...
public class Activity_480 extends Activity
{
	public void launch(){
		...
		//null;;null;;null;;null;;String->observation->999999999999999999999999999999999999999999999999999,boolean->is_new_observation->false,int->observation_id->Integer.MIN_VALUE,int->observation_id_internal->Integer.MIN_VALUE,int->current_photo_index->0,boolean->read_only->true,
	}
