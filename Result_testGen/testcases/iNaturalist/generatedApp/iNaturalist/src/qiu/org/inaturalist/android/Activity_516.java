...
public class Activity_516 extends Activity
{
	public void launch(){
		...
		//null;;null;;null;;null;;Serializable->observation_id_internal->SerializableObj,boolean->is_new_observation->false,Serializable->observation_id->SerializableObj,int->current_photo_index->Integer.MIN_VALUE,boolean->read_only->true,
	}
