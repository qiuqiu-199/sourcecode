...
public class Activity_1012 extends Activity
{
	public void launch(){
		...
		//null;;null;;null;;null;;String->search_hint_text->abcde,boolean->is_user->false,String->search_url->abcde,String->result_viewer_activity_param_name->999999999999999999999999999999999999999999999999999,boolean->return_result->true,String->new com.adobe.xmp.properties.XMPPropertyInfo->abcde,Serializable->result_viewer_activity->SerializableObj,
	}
