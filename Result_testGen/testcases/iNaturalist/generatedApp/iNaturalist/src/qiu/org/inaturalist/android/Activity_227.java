...
public class Activity_227 extends Activity
{
	public void launch(){
		...
		//explore_get_observers_result;;null;;null;;null;;Serializable->results->SerializableObj,boolean->is_shared_on_app->true,int->active_tab->Integer.MAX_VALUE,String->new com.adobe.xmp.properties.XMPPropertyInfo->abcde,String->error->!@#$%^ds:+_,Serializable->search_filters->SerializableObj,
	}
