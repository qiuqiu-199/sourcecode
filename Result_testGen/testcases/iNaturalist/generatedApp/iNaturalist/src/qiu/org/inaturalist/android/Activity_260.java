...
public class Activity_260 extends Activity
{
	public void launch(){
		...
		//null;;null;;null;;null;;Serializable->observation_id_internal->SerializableObj,String->observation->!@#$%^ds:+_,Serializable->longitude->SerializableObj,Serializable->observation_id->SerializableObj,Serializable->latitude->SerializableObj,boolean->suggest_id->false,Serializable->observed_on->SerializableObj,
	}
