...
public class Activity_787 extends Activity
{
	public void launch(){
		...
		//.action_refresh;;null;;null;;null;;Bundle->.extra_params->BundleObj,(,),String->.extra_url->!@#$%^ds:+_,String->.extra_chromePackage->!@#$%^ds:+_,
	}
