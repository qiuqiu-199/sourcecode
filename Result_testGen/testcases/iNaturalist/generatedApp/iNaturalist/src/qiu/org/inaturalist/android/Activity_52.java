...
public class Activity_52 extends Activity
{
	public void launch(){
		...
		//null;;null;;null;;null;;boolean->login->false,boolean->show_skip->false,String->new com.adobe.xmp.properties.XMPPropertyInfo->999999999999999999999999999999999999999999999999999,String->accountType->!@#$%^ds:+_,String->authAccount->!@#$%^ds:+_,Parcelable->com.facebook.LoginFragment:Result->ParcelableObj,
	}
