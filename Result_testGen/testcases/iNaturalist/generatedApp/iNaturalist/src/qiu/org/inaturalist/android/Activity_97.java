...
public class Activity_97 extends Activity
{
	public void launch(){
		...
		intent.putExtra("obs_photo_filename", "!@#$%^ds:+_");
		...
		//null;;null;;null;;null;;Serializable->observation_id_internal->SerializableObj,String->observation->999999999999999999999999999999999999999999999999999,String->obs_photo_filename->!@#$%^ds:+_,Serializable->longitude->SerializableObj,Serializable->observation_id->SerializableObj,Serializable->latitude->SerializableObj,Serializable->observed_on->SerializableObj,String->obs_photo_url->abcde,
	}
