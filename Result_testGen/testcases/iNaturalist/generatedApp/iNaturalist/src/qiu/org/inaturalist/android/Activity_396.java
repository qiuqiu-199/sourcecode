...
public class Activity_396 extends Activity
{
	public void launch(){
		...
		//android.net.conn.CONNECTIVITY_CHANGE;;null;;?;;null;;Serializable->results->SerializableObj,Serializable->observations->SerializableObj,Serializable->user->SerializableObj,boolean->first_sync->false,boolean->sync_canceled->true,String->username->999999999999999999999999999999999999999999999999999,Serializable->species_count_result->SerializableObj,Serializable->identifications->SerializableObj,boolean->is_shared_on_app->true,String->new com.adobe.xmp.properties.XMPPropertyInfo->!@#$%^ds:+_,boolean->noConnectivity->true,String->error->abcde,boolean->from_obs_editor->false,
	}
