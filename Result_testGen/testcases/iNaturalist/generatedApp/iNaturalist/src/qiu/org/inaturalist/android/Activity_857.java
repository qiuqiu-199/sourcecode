...
public class Activity_857 extends Activity
{
	public void launch(){
		...
		//null;;null;;null;;null;;int->taxon_suggestion->Integer.MIN_VALUE,boolean->download_taxon->true,Serializable->taxon->SerializableObj,
	}
