...
public class Activity_886 extends Activity
{
	public void launch(){
		...
		//get_project_observations_result;;null;;null;;null;;String->project->abcde,Serializable->results->SerializableObj,boolean->is_shared_on_app->true,String->new com.adobe.xmp.properties.XMPPropertyInfo->!@#$%^ds:+_,String->error->999999999999999999999999999999999999999999999999999,
	}
