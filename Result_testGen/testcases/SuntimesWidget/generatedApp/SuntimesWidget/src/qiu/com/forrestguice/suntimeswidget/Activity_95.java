...
public class Activity_95 extends Activity
{
	public void launch(){
		...
		intent.setAction("com.forrestguice.suntimeswidget.PREFS_ALARMCLOCK");
		intent.putExtra("isModified", false);
		intent.putExtra("name", "!@#$%^ds:+_");
		startActivity(intent);
		//com.forrestguice.suntimeswidget.PREFS_ALARMCLOCK;;null;;null;;null;;String->name->!@#$%^ds:+_,boolean->isModified->false,
	}
