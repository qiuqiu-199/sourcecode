...
public class Activity_124 extends Activity
{
	public void launch(){
		...
		//android.intent.action.SET_ALARM;;null;;null;;null;;String->solarevent->abcde,int->android.intent.extra.alarm.HOUR->0,int->android.intent.extra.alarm.MINUTES->Integer.MAX_VALUE,
	}
