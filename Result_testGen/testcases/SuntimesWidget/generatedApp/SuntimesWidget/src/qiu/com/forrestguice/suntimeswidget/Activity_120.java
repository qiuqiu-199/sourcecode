...
public class Activity_120 extends Activity
{
	public void launch(){
		...
		//android.intent.action.SET_ALARM;;null;;null;;null;;String->solarevent->!@#$%^ds:+_,int->android.intent.extra.alarm.HOUR->0,int->android.intent.extra.alarm.MINUTES->Integer.MAX_VALUE,
	}
