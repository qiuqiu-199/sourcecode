...
public class Activity_170 extends Activity
{
	public void launch(){
		...
		//suntimeswidget.alarm.delete;;null;;?;;null;;IntegerArrayList->android.intent.extra.alarm.DAYS->Integer.MAX_VALUE,String->solarevent->999999999999999999999999999999999999999999999999999,int->android.intent.extra.alarm.HOUR->0,String->android.intent.extra.alarm.RINGTONE->999999999999999999999999999999999999999999999999999,int->android.intent.extra.alarm.MINUTES->Integer.MAX_VALUE,boolean->showBack->true,String->android.intent.extra.alarm.MESSAGE->!@#$%^ds:+_,long->selectedAlarm->Long.MAX_VALUE,Parcelable->android.intent.extra.ringtone.PICKED_URI->ParcelableObj,boolean->android.intent.extra.alarm.VIBRATE->true,
	}
