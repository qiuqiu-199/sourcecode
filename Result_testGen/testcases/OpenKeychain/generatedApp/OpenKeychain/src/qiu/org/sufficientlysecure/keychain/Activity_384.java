...
public class Activity_384 extends Activity
{
	public void launch(){
		...
		//android.nfc.action.TAG_DISCOVERED;;null;;?;;null;;byteArray->fingerprint->0,Parcelable->result_data->ParcelableObj,Parcelable->operation_result->ParcelableObj,long->master_key_id->Long.MIN_VALUE,Parcelable->display_result->ParcelableObj,Parcelable->result_crypto_input->ParcelableObj,
	}
