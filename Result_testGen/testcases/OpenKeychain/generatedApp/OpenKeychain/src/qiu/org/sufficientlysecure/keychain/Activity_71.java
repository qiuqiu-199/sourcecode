...
public class Activity_71 extends Activity
{
	public void launch(){
		...
		//android.intent.action.SEND;;null;;notEmpty;;application/autocrypt-setup;;Parcelable->android.intent.extra.STREAM->ParcelableObj,String->android.intent.extra.TEXT->abcde,
	}
