...
public class Activity_469 extends Activity
{
	public void launch(){
		...
		//android.nfc.action.TAG_DISCOVERED;;null;;null;;null;;boolean->create_yubi_key->false,Parcelable->token_info->ParcelableObj,String->name->!@#$%^ds:+_,boolean->first_time->false,Parcelable->android.nfc.extra.TAG->ParcelableObj,String->email->999999999999999999999999999999999999999999999999999,
	}
