.class public Lorg/inaturalist/android/MissionsActivity$$StateSaver;
.super Lcom/evernote/android/state/Injector$Object;
.source "MissionsActivity$$StateSaver.java"
...
.annotation system Ldalvik/annotation/Signature;
    value = {
        "<T:",
        "Lorg/inaturalist/android/MissionsActivity;",
        ">",
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/inaturalist/android/MissionsActivity$$StateSaver;->BUNDLERS:Ljava/util/HashMap;

    .line 43
    new-instance v0, Lcom/evernote/android/state/InjectionHelper;

    const-string v1, "org.inaturalist.android.MissionsActivity$$StateSaver"

    sget-object v2, Lorg/inaturalist/android/MissionsActivity$$StateSaver;->BUNDLERS:Ljava/util/HashMap;

    invoke-direct {v0, v1, v2}, Lcom/evernote/android/state/InjectionHelper;-><init>(Ljava/lang/String;Ljava/util/Map;)V

    sput-object v0, Lorg/inaturalist/android/MissionsActivity$$StateSaver;->HELPER:Lcom/evernote/android/state/InjectionHelper;

    .line 46
    sget-object v0, Lorg/inaturalist/android/MissionsActivity$$StateSaver;->BUNDLERS:Ljava/util/HashMap;
...
.method public bridge synthetic restore(Ljava/lang/Object;Landroid/os/Bundle;)V
    ...
    .line 40
    check-cast p1, Lorg/inaturalist/android/MissionsActivity;

    invoke-virtual {p0, p1, p2}, Lorg/inaturalist/android/MissionsActivity$$StateSaver;->restore(Lorg/inaturalist/android/MissionsActivity;Landroid/os/Bundle;)V

    return-void
.end method

.method public restore(Lorg/inaturalist/android/MissionsActivity;Landroid/os/Bundle;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(TT;",
    ...
    .line 60
    sget-object v0, Lorg/inaturalist/android/MissionsActivity$$StateSaver;->HELPER:Lcom/evernote/android/state/InjectionHelper;

    const-string v1, "mAskedForLocationPermissions"

    invoke-virtual {v0, p2, v1}, Lcom/evernote/android/state/InjectionHelper;->getBoolean(Landroid/os/Bundle;Ljava/lang/String;)Z

    move-result v0

    iput-boolean v0, p1, Lorg/inaturalist/android/MissionsActivity;->mAskedForLocationPermissions:Z
    ...
    iput v0, p1, Lorg/inaturalist/android/MissionsActivity;->mMissionsCurrentExpansionLevel:I
...
.method public bridge synthetic save(Ljava/lang/Object;Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, p1, p2}, Lorg/inaturalist/android/MissionsActivity$$StateSaver;->save(Lorg/inaturalist/android/MissionsActivity;Landroid/os/Bundle;)V

    return-void
.end method

.method public save(Lorg/inaturalist/android/MissionsActivity;Landroid/os/Bundle;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(TT;",
    ...
    iget-boolean v2, p1, Lorg/inaturalist/android/MissionsActivity;->mAskedForLocationPermissions:Z
    ...
    iget v2, p1, Lorg/inaturalist/android/MissionsActivity;->mMissionsCurrentExpansionLevel:I
