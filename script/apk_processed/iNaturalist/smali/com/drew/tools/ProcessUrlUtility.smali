...
.method private static processUrl(Ljava/net/URL;)V
    ...
    const-string v5, "%s: %s [Error Extracting Metadata]%n"
    ...
    const-string v6, "%s: %s [Error Extracting Metadata]%n\t%s%n"
    ...
    invoke-virtual {v5, v6, v1}, Ljava/io/PrintStream;->printf(Ljava/lang/String;[Ljava/lang/Object;)Ljava/io/PrintStream;
