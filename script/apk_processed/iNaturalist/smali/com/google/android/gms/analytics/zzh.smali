...
.method constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lcom/google/android/gms/analytics/zzh;->mContext:Landroid/content/Context;

    new-instance p1, Lcom/google/android/gms/analytics/zzh$zza;

    invoke-direct {p1, p0}, Lcom/google/android/gms/analytics/zzh$zza;-><init>(Lcom/google/android/gms/analytics/zzh;)V

    iput-object p1, p0, Lcom/google/android/gms/analytics/zzh;->zzack:Lcom/google/android/gms/analytics/zzh$zza;

    new-instance p1, Ljava/util/concurrent/CopyOnWriteArrayList;

    invoke-direct {p1}, Ljava/util/concurrent/CopyOnWriteArrayList;-><init>()V

    iput-object p1, p0, Lcom/google/android/gms/analytics/zzh;->zzaci:Ljava/util/List;

    new-instance p1, Lcom/google/android/gms/analytics/zzd;

    invoke-direct {p1}, Lcom/google/android/gms/analytics/zzd;-><init>()V

    iput-object p1, p0, Lcom/google/android/gms/analytics/zzh;->zzacj:Lcom/google/android/gms/analytics/zzd;
...
.method static synthetic zza(Lcom/google/android/gms/analytics/zzh;)Ljava/util/List;
    ...
    iget-object p0, p0, Lcom/google/android/gms/analytics/zzh;->zzaci:Ljava/util/List;
...
.method public static zzam(Landroid/content/Context;)Lcom/google/android/gms/analytics/zzh;
    ...
    const-class v0, Lcom/google/android/gms/analytics/zzh;

    monitor-enter v0

    :try_start_0
    sget-object v1, Lcom/google/android/gms/analytics/zzh;->zzach:Lcom/google/android/gms/analytics/zzh;

    if-nez v1, :cond_0

    new-instance v1, Lcom/google/android/gms/analytics/zzh;

    invoke-direct {v1, p0}, Lcom/google/android/gms/analytics/zzh;-><init>(Landroid/content/Context;)V

    sput-object v1, Lcom/google/android/gms/analytics/zzh;->zzach:Lcom/google/android/gms/analytics/zzh;
    ...
    :cond_1
    :goto_0
    sget-object p0, Lcom/google/android/gms/analytics/zzh;->zzach:Lcom/google/android/gms/analytics/zzh;
...
.method static synthetic zzb(Lcom/google/android/gms/analytics/zzh;)Ljava/lang/Thread$UncaughtExceptionHandler;
    ...
    iget-object p0, p0, Lcom/google/android/gms/analytics/zzh;->zzacm:Ljava/lang/Thread$UncaughtExceptionHandler;
...
.method private zzb(Lcom/google/android/gms/analytics/zze;)V
    ...
    invoke-interface {v2}, Lcom/google/android/gms/analytics/zzi;->zzmr()Landroid/net/Uri;
    ...
    invoke-interface {v2, p1}, Lcom/google/android/gms/analytics/zzi;->zzb(Lcom/google/android/gms/analytics/zze;)V
...
.method zze(Lcom/google/android/gms/analytics/zze;)V
    ...
    invoke-virtual {p1}, Lcom/google/android/gms/analytics/zze;->zzmI()V

    iget-object v0, p0, Lcom/google/android/gms/analytics/zzh;->zzack:Lcom/google/android/gms/analytics/zzh$zza;

    new-instance v1, Lcom/google/android/gms/analytics/zzh$1;

    invoke-direct {v1, p0, p1}, Lcom/google/android/gms/analytics/zzh$1;-><init>(Lcom/google/android/gms/analytics/zzh;Lcom/google/android/gms/analytics/zze;)V

    invoke-virtual {v0, v1}, Lcom/google/android/gms/analytics/zzh$zza;->execute(Ljava/lang/Runnable;)V
...
.method public zzmP()Lcom/google/android/gms/internal/zzrk;
    .locals 7
    ...
    iget-object v1, p0, Lcom/google/android/gms/analytics/zzh;->mContext:Landroid/content/Context;

    invoke-virtual {v1}, Landroid/content/Context;->getPackageManager()Landroid/content/pm/PackageManager;

    move-result-object v1

    iget-object v2, p0, Lcom/google/android/gms/analytics/zzh;->mContext:Landroid/content/Context;

    invoke-virtual {v2}, Landroid/content/Context;->getPackageName()Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v0, v2}, Lcom/google/android/gms/internal/zzrk;->setAppId(Ljava/lang/String;)V

    invoke-virtual {v1, v2}, Landroid/content/pm/PackageManager;->getInstallerPackageName(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v3

    invoke-virtual {v0, v3}, Lcom/google/android/gms/internal/zzrk;->setAppInstallerId(Ljava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :cond_2
    :goto_1
    invoke-virtual {v0, v2}, Lcom/google/android/gms/internal/zzrk;->setAppName(Ljava/lang/String;)V

    invoke-virtual {v0, v3}, Lcom/google/android/gms/internal/zzrk;->setAppVersion(Ljava/lang/String;)V

    iput-object v0, p0, Lcom/google/android/gms/analytics/zzh;->zzacl:Lcom/google/android/gms/internal/zzrk;
...
.method public zzmQ()Lcom/google/android/gms/internal/zzrp;
    .locals 3
