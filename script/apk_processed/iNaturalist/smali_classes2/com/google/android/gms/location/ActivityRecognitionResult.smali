...
.method public constructor <init>(Ljava/util/List;JJILandroid/os/Bundle;)V
    ...
    iput-object p1, p0, Lcom/google/android/gms/location/ActivityRecognitionResult;->zzbjq:Ljava/util/List;

    iput-wide p2, p0, Lcom/google/android/gms/location/ActivityRecognitionResult;->zzbjr:J

    iput-wide p4, p0, Lcom/google/android/gms/location/ActivityRecognitionResult;->zzbjs:J

    iput p6, p0, Lcom/google/android/gms/location/ActivityRecognitionResult;->zzbjt:I
...
.method public static extractResult(Landroid/content/Intent;)Lcom/google/android/gms/location/ActivityRecognitionResult;
    ...
    invoke-static {p0}, Lcom/google/android/gms/location/ActivityRecognitionResult;->zzu(Landroid/content/Intent;)Lcom/google/android/gms/location/ActivityRecognitionResult;
    ...
    :cond_0
    invoke-static {p0}, Lcom/google/android/gms/location/ActivityRecognitionResult;->zzw(Landroid/content/Intent;)Ljava/util/List;
...
.method public static hasResult(Landroid/content/Intent;)Z
    ...
    :cond_0
    invoke-static {p0}, Lcom/google/android/gms/location/ActivityRecognitionResult;->zzt(Landroid/content/Intent;)Z
...
.method private static zzt(Landroid/content/Intent;)Z
    .locals 1
...
.method private static zzu(Landroid/content/Intent;)Lcom/google/android/gms/location/ActivityRecognitionResult;
    .locals 2
    ...
    invoke-static {p0, v0}, Lcom/google/android/gms/common/internal/safeparcel/zzd;->zza([BLandroid/os/Parcelable$Creator;)Lcom/google/android/gms/common/internal/safeparcel/SafeParcelable;
...
.method public static zzv(Landroid/content/Intent;)Z
    .locals 1
...
.method public static zzw(Landroid/content/Intent;)Ljava/util/List;
    .locals 2
    .annotation build Landroid/support/annotation/Nullable;
    .end annotation
    ...
    invoke-static {p0}, Lcom/google/android/gms/location/ActivityRecognitionResult;->zzv(Landroid/content/Intent;)Z
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget-wide v2, p0, Lcom/google/android/gms/location/ActivityRecognitionResult;->zzbjr:J

    iget-wide v4, p1, Lcom/google/android/gms/location/ActivityRecognitionResult;->zzbjr:J

    cmp-long v6, v2, v4

    if-nez v6, :cond_2

    iget-wide v2, p0, Lcom/google/android/gms/location/ActivityRecognitionResult;->zzbjs:J

    iget-wide v4, p1, Lcom/google/android/gms/location/ActivityRecognitionResult;->zzbjs:J

    cmp-long v6, v2, v4

    if-nez v6, :cond_2

    iget v2, p0, Lcom/google/android/gms/location/ActivityRecognitionResult;->zzbjt:I

    iget v3, p1, Lcom/google/android/gms/location/ActivityRecognitionResult;->zzbjt:I

    if-ne v2, v3, :cond_2

    iget-object v2, p0, Lcom/google/android/gms/location/ActivityRecognitionResult;->zzbjq:Ljava/util/List;

    iget-object v3, p1, Lcom/google/android/gms/location/ActivityRecognitionResult;->zzbjq:Ljava/util/List;
...
.method public getActivityConfidence(I)I
    ...
    iget-object v0, p0, Lcom/google/android/gms/location/ActivityRecognitionResult;->zzbjq:Ljava/util/List;
...
.method public getElapsedRealtimeMillis()J
    ...
    iget-wide v0, p0, Lcom/google/android/gms/location/ActivityRecognitionResult;->zzbjs:J
...
.method public getTime()J
    ...
    iget-wide v0, p0, Lcom/google/android/gms/location/ActivityRecognitionResult;->zzbjr:J
...
.method public hashCode()I
    ...
    iget-wide v1, p0, Lcom/google/android/gms/location/ActivityRecognitionResult;->zzbjr:J
    ...
    iget-wide v1, p0, Lcom/google/android/gms/location/ActivityRecognitionResult;->zzbjs:J
    ...
    iget v1, p0, Lcom/google/android/gms/location/ActivityRecognitionResult;->zzbjt:I
    ...
    iget-object v1, p0, Lcom/google/android/gms/location/ActivityRecognitionResult;->zzbjq:Ljava/util/List;
...
.method public toString()Ljava/lang/String;
    ...
    iget-wide v3, p0, Lcom/google/android/gms/location/ActivityRecognitionResult;->zzbjs:J
