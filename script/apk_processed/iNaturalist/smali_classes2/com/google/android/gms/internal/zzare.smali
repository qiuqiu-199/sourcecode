...
# static fields
.field private static zzbiI:Ljava/lang/Boolean;

.field private static zzbiJ:Landroid/content/ContentProviderClient;
...
.method static declared-synchronized reset()V
    ...
    const-class v0, Lcom/google/android/gms/internal/zzare;

    monitor-enter v0

    :try_start_0
    sget-object v1, Lcom/google/android/gms/internal/zzare;->zzbiJ:Landroid/content/ContentProviderClient;
    ...
    sput-object v2, Lcom/google/android/gms/internal/zzare;->zzbiJ:Landroid/content/ContentProviderClient;

    :cond_0
    sput-object v2, Lcom/google/android/gms/internal/zzare;->zzbiI:Ljava/lang/Boolean;
    :try_end_0
...
.method private static zza(Landroid/content/Context;Ljava/lang/String;Landroid/os/Parcelable;Z)Landroid/content/Intent;
    ...
    const-string v3, "key_fallbackIntent"
    ...
    invoke-static {p0, v5, p1, v2}, Lcom/google/android/gms/internal/zzare;->zza(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    :cond_2
    const-string p0, "key_instantAppIntent"
    ...
    const-string p1, "InstantAppsApi"

    const-string p2, "While calling %s %s:\n"

    new-array p3, v3, [Ljava/lang/Object;

    sget-object v2, Lcom/google/android/gms/internal/zzaqv;->zzbiv:Landroid/net/Uri;
    ...
    const-string v5, "InstantAppsApi"

    const-string v6, "While calling %s %s:\n"

    new-array v3, v3, [Ljava/lang/Object;

    sget-object v7, Lcom/google/android/gms/internal/zzaqv;->zzbiv:Landroid/net/Uri;

    aput-object v7, v3, v4

    const-string v7, "method_getInstantAppIntent"
    ...
    invoke-static {p0, p1, p2, v4}, Lcom/google/android/gms/internal/zzare;->zza(Landroid/content/Context;Ljava/lang/String;Landroid/os/Parcelable;Z)Landroid/content/Intent;
...
.method private static declared-synchronized zza(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    sget-object v1, Lcom/google/android/gms/internal/zzaqv;->zzbiv:Landroid/net/Uri;
...
.method private static declared-synchronized zzbC(Landroid/content/Context;)Z
    ...
    sput-object p0, Lcom/google/android/gms/internal/zzare;->zzbiJ:Landroid/content/ContentProviderClient;

    :cond_0
    sget-object p0, Lcom/google/android/gms/internal/zzare;->zzbiJ:Landroid/content/ContentProviderClient;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method static declared-synchronized zzbD(Landroid/content/Context;)Z
    ...
    :try_start_0
    sget-object v1, Lcom/google/android/gms/internal/zzare;->zzbiI:Ljava/lang/Boolean;

    if-eqz v1, :cond_0

    sget-object p0, Lcom/google/android/gms/internal/zzare;->zzbiI:Ljava/lang/Boolean;
    ...
    sput-object p0, Lcom/google/android/gms/internal/zzare;->zzbiI:Ljava/lang/Boolean;
...
.method private static declared-synchronized zzbE(Landroid/content/Context;)Z
    ...
    sget-object v3, Lcom/google/android/gms/internal/zzaqv;->zzbiv:Landroid/net/Uri;
