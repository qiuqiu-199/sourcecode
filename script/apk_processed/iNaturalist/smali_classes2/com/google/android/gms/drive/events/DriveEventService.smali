...
.field private zzaLR:Ljava/util/concurrent/CountDownLatch;

.field zzaLS:Lcom/google/android/gms/drive/events/DriveEventService$zza;
...
.method protected constructor <init>(Ljava/lang/String;)V
    ...
    iput-boolean v0, p0, Lcom/google/android/gms/drive/events/DriveEventService;->zzaLT:Z

    const/4 v0, -0x1

    iput v0, p0, Lcom/google/android/gms/drive/events/DriveEventService;->zzaEV:I
...
.method private zzAO()V
    ...
    iget v1, p0, Lcom/google/android/gms/drive/events/DriveEventService;->zzaEV:I
...
.method static synthetic zza(Lcom/google/android/gms/drive/events/DriveEventService;)V
    ...
    invoke-direct {p0}, Lcom/google/android/gms/drive/events/DriveEventService;->zzAO()V

    return-void
.end method

.method static synthetic zza(Lcom/google/android/gms/drive/events/DriveEventService;Lcom/google/android/gms/internal/zzajp;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/google/android/gms/drive/events/DriveEventService;->zza(Lcom/google/android/gms/internal/zzajp;)V

    return-void
.end method

.method private zza(Lcom/google/android/gms/internal/zzajp;)V
    .locals 4
    ...
    invoke-static {v0, v1}, Lcom/google/android/gms/internal/zzaic;->zzE(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v0, v1}, Lcom/google/android/gms/internal/zzaic;->zzF(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v0}, Lcom/google/android/gms/drive/events/DriveEventService;->zza(Lcom/google/android/gms/drive/events/zzr;)V
    ...
    invoke-static {v1, v0, p1}, Lcom/google/android/gms/internal/zzaic;->zza(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;)V
...
.method static synthetic zzb(Lcom/google/android/gms/drive/events/DriveEventService;)Ljava/util/concurrent/CountDownLatch;
    ...
    iget-object p0, p0, Lcom/google/android/gms/drive/events/DriveEventService;->zzaLR:Ljava/util/concurrent/CountDownLatch;
...
.method public final declared-synchronized onBind(Landroid/content/Intent;)Landroid/os/IBinder;
    ...
    iget-object p1, p0, Lcom/google/android/gms/drive/events/DriveEventService;->zzaLS:Lcom/google/android/gms/drive/events/DriveEventService$zza;

    if-nez p1, :cond_0

    iget-boolean p1, p0, Lcom/google/android/gms/drive/events/DriveEventService;->zzaLT:Z

    if-nez p1, :cond_0

    const/4 p1, 0x1

    iput-boolean p1, p0, Lcom/google/android/gms/drive/events/DriveEventService;->zzaLT:Z
    ...
    iput-object v1, p0, Lcom/google/android/gms/drive/events/DriveEventService;->zzaLR:Ljava/util/concurrent/CountDownLatch;

    new-instance p1, Lcom/google/android/gms/drive/events/DriveEventService$1;

    invoke-direct {p1, p0, v0}, Lcom/google/android/gms/drive/events/DriveEventService$1;-><init>(Lcom/google/android/gms/drive/events/DriveEventService;Ljava/util/concurrent/CountDownLatch;)V

    invoke-virtual {p1}, Lcom/google/android/gms/drive/events/DriveEventService$1;->start()V
    :try_end_0
...
.method public declared-synchronized onDestroy()V
    ...
    iget-object v0, p0, Lcom/google/android/gms/drive/events/DriveEventService;->zzaLS:Lcom/google/android/gms/drive/events/DriveEventService$zza;
    ...
    iget-object v1, p0, Lcom/google/android/gms/drive/events/DriveEventService;->zzaLS:Lcom/google/android/gms/drive/events/DriveEventService$zza;

    invoke-virtual {v1, v0}, Lcom/google/android/gms/drive/events/DriveEventService$zza;->sendMessage(Landroid/os/Message;)Z

    const/4 v0, 0x0

    iput-object v0, p0, Lcom/google/android/gms/drive/events/DriveEventService;->zzaLS:Lcom/google/android/gms/drive/events/DriveEventService$zza;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    :try_start_1
    iget-object v1, p0, Lcom/google/android/gms/drive/events/DriveEventService;->zzaLR:Ljava/util/concurrent/CountDownLatch;
    ...
    invoke-static {v1, v2}, Lcom/google/android/gms/internal/zzaic;->zzF(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_1
    .catch Ljava/lang/InterruptedException; {:try_start_1 .. :try_end_1} :catch_0
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    :cond_0
    :try_start_2
    iput-object v0, p0, Lcom/google/android/gms/drive/events/DriveEventService;->zzaLR:Ljava/util/concurrent/CountDownLatch;
...
.method public zza(Lcom/google/android/gms/drive/events/zzr;)V
    ...
    const-string v1, "Unhandled transfer state event: "
