...
.method private static intersects(DDDDDZ)Z
    ...
    cmpl-double v11, p8, v8

    if-ltz v11, :cond_0

    cmpl-double v11, p8, p4

    if-gez v11, :cond_1

    :cond_0
    cmpg-double v11, p8, v8

    if-gez v11, :cond_2

    cmpg-double v11, p8, p4
    ...
    :cond_3
    cmpg-double v13, p0, v11

    if-lez v13, :cond_b

    cmpg-double v13, p2, v11

    if-lez v13, :cond_b

    const-wide v11, 0x3ff921fb54442d18L    # 1.5707963267948966

    cmpl-double v13, p0, v11

    if-gez v13, :cond_b

    cmpl-double v13, p2, v11
    ...
    :cond_4
    const-wide v13, -0x3ff6de04abbbd2e8L    # -3.141592653589793

    cmpg-double v15, p4, v13
    ...
    sub-double v13, p4, p8

    mul-double v13, v13, p0

    mul-double v15, p2, p8

    add-double/2addr v13, v15

    div-double v13, v13, p4

    cmpl-double v15, p0, v8

    if-ltz v15, :cond_6

    cmpl-double v15, p2, v8

    if-ltz v15, :cond_6

    cmpg-double v15, p6, v13
...
.method private static isOnSegmentGC(DDDDDDD)Z
    ...
    .line 327
    invoke-static {v13, v14}, Lcom/google/maps/android/MathUtil;->havFromSin(D)D

    move-result-wide v4

    const/4 v13, 0x0

    cmpl-double v14, v4, p12
    ...
    .line 342
    invoke-static {v8, v9, v11, v12}, Lcom/google/maps/android/MathUtil;->sinSumFromHav(DD)D
...
.method private static locationIndexOnEdgeOrPath(Lcom/google/android/gms/maps/model/LatLng;Ljava/util/List;ZZD)I
    .locals 41
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 263
    iget-wide v2, v13, Lcom/google/android/gms/maps/model/LatLng;->longitude:D
    ...
    cmpg-double v4, v6, v31

    if-gtz v4, :cond_6

    sub-double v6, v2, v8

    const-wide v28, -0x3ff6de04abbbd2e8L    # -3.141592653589793
    ...
    :cond_4
    mul-double v37, v28, v6

    const/4 v9, 0x0

    sub-double v39, v14, v16

    mul-double v39, v39, v33

    add-double v37, v37, v39

    div-double v35, v37, v35
