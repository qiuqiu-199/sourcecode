...
# instance fields
.field private final zzcno:Landroid/net/Uri;

.field private final zzcnp:Lcom/google/firebase/storage/FirebaseStorage;
...
.method constructor <init>(Landroid/net/Uri;Lcom/google/firebase/storage/FirebaseStorage;)V
    ...
    iput-object p1, p0, Lcom/google/firebase/storage/StorageReference;->zzcno:Landroid/net/Uri;

    iput-object p2, p0, Lcom/google/firebase/storage/StorageReference;->zzcnp:Lcom/google/firebase/storage/FirebaseStorage;
...
.method public child(Ljava/lang/String;)Lcom/google/firebase/storage/StorageReference;
    ...
    :try_start_0
    iget-object v0, p0, Lcom/google/firebase/storage/StorageReference;->zzcno:Landroid/net/Uri;

    invoke-virtual {v0}, Landroid/net/Uri;->buildUpon()Landroid/net/Uri$Builder;

    move-result-object v0

    invoke-static {p1}, Lcom/google/android/gms/internal/zzbtw;->zzjI(Ljava/lang/String;)Ljava/lang/String;
    ...
    new-instance p1, Lcom/google/firebase/storage/StorageReference;

    iget-object v1, p0, Lcom/google/firebase/storage/StorageReference;->zzcnp:Lcom/google/firebase/storage/FirebaseStorage;

    invoke-direct {p1, v0, v1}, Lcom/google/firebase/storage/StorageReference;-><init>(Landroid/net/Uri;Lcom/google/firebase/storage/FirebaseStorage;)V
    ...
    const-string v1, "Unable to create a valid default Uri. "
...
.method public getBytes(J)Lcom/google/android/gms/tasks/Task;
    ...
    new-instance v2, Lcom/google/firebase/storage/StorageReference$5;

    invoke-direct {v2, p0, p1, p2, v0}, Lcom/google/firebase/storage/StorageReference$5;-><init>(Lcom/google/firebase/storage/StorageReference;JLcom/google/android/gms/tasks/TaskCompletionSource;)V
    ...
    new-instance p2, Lcom/google/firebase/storage/StorageReference$4;

    invoke-direct {p2, p0, v0}, Lcom/google/firebase/storage/StorageReference$4;-><init>(Lcom/google/firebase/storage/StorageReference;Lcom/google/android/gms/tasks/TaskCompletionSource;)V

    invoke-virtual {p1, p2}, Lcom/google/firebase/storage/StorageTask;->addOnSuccessListener(Lcom/google/android/gms/tasks/OnSuccessListener;)Lcom/google/android/gms/tasks/Task;

    move-result-object p1

    check-cast p1, Lcom/google/firebase/storage/StorageTask;

    new-instance p2, Lcom/google/firebase/storage/StorageReference$3;

    invoke-direct {p2, p0, v0}, Lcom/google/firebase/storage/StorageReference$3;-><init>(Lcom/google/firebase/storage/StorageReference;Lcom/google/android/gms/tasks/TaskCompletionSource;)V

    invoke-virtual {p1, p2}, Lcom/google/firebase/storage/StorageTask;->addOnFailureListener(Lcom/google/android/gms/tasks/OnFailureListener;)Lcom/google/android/gms/tasks/Task;

    invoke-virtual {v1}, Lcom/google/firebase/storage/StreamDownloadTask;->zzacA()Z
...
.method public getFile(Landroid/net/Uri;)Lcom/google/firebase/storage/FileDownloadTask;
    ...
    invoke-virtual {v0}, Lcom/google/firebase/storage/FileDownloadTask;->zzacA()Z
...
.method public getParent()Lcom/google/firebase/storage/StorageReference;
    ...
    :goto_0
    iget-object v1, p0, Lcom/google/firebase/storage/StorageReference;->zzcno:Landroid/net/Uri;
    ...
    iget-object v2, p0, Lcom/google/firebase/storage/StorageReference;->zzcnp:Lcom/google/firebase/storage/FirebaseStorage;
...
.method public getStorage()Lcom/google/firebase/storage/FirebaseStorage;
    ...
    iget-object v0, p0, Lcom/google/firebase/storage/StorageReference;->zzcnp:Lcom/google/firebase/storage/FirebaseStorage;
...
.method public getStream()Lcom/google/firebase/storage/StreamDownloadTask;
    ...
    invoke-virtual {v0}, Lcom/google/firebase/storage/StreamDownloadTask;->zzacA()Z
...
.method public putBytes([B)Lcom/google/firebase/storage/UploadTask;
    ...
    invoke-virtual {v0}, Lcom/google/firebase/storage/UploadTask;->zzacA()Z
...
.method zzacy()Lcom/google/android/gms/internal/zzbud;
    .locals 1
    .annotation build Landroid/support/annotation/NonNull;
    .end annotation
