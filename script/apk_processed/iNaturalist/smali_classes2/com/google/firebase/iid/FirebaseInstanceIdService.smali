...
.method static zza(Landroid/content/Context;Lcom/google/firebase/iid/FirebaseInstanceId;)V
    ...
    sget-object v0, Lcom/google/firebase/iid/FirebaseInstanceIdService;->zzclo:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    sget-boolean v1, Lcom/google/firebase/iid/FirebaseInstanceIdService;->zzclp:Z
    ...
    invoke-virtual {p1}, Lcom/google/firebase/iid/zze;->zzabS()Ljava/lang/String;
...
.method private zza(Landroid/content/Intent;ZZ)V
    ...
    sget-object p2, Lcom/google/firebase/iid/FirebaseInstanceIdService;->zzclo:Ljava/lang/Object;
    ...
    invoke-virtual {p2}, Lcom/google/firebase/iid/FirebaseInstanceId;->zzabN()Lcom/google/firebase/iid/zzh$zza;
    ...
    :cond_1
    invoke-virtual {p2}, Lcom/google/firebase/iid/FirebaseInstanceId;->zzabP()Lcom/google/firebase/iid/zze;

    move-result-object p2

    :goto_0
    invoke-virtual {p2}, Lcom/google/firebase/iid/zze;->zzabS()Ljava/lang/String;
    ...
    iget-boolean v1, p0, Lcom/google/firebase/iid/FirebaseInstanceIdService;->zzclq:Z
    ...
    :goto_5
    :try_start_2
    invoke-virtual {p2}, Lcom/google/firebase/iid/FirebaseInstanceId;->zzabO()Ljava/lang/String;
    ...
    iget-object p2, v1, Lcom/google/firebase/iid/zzh$zza;->zzbxT:Ljava/lang/String;
...
.method private zza(Lcom/google/firebase/iid/zzf;Landroid/os/Bundle;)V
    ...
    const-string p2, "Unable to respond to ping due to missing target package"
    ...
    const-string p2, "google.com/iid"
...
.method static synthetic zza(Lcom/google/firebase/iid/FirebaseInstanceIdService;)Z
    ...
    iget-boolean p0, p0, Lcom/google/firebase/iid/FirebaseInstanceIdService;->zzclq:Z
...
.method static zzcs(Landroid/content/Context;)V
    ...
    invoke-virtual {v1, p0, v2}, Lcom/google/firebase/iid/zzg;->zzf(Landroid/content/Context;Landroid/content/Intent;)V

    const/4 p0, 0x1

    sput-boolean p0, Lcom/google/firebase/iid/FirebaseInstanceIdService;->zzclp:Z
...
.method private zzd(Landroid/content/Intent;Ljava/lang/String;)V
    ...
    sput-boolean v1, Lcom/google/firebase/iid/FirebaseInstanceIdService;->zzclp:Z
    ...
    iget-boolean p2, p0, Lcom/google/firebase/iid/FirebaseInstanceIdService;->zzclq:Z
    ...
    :cond_0
    sget-object p2, Lcom/google/firebase/iid/FirebaseInstanceIdService;->zzcln:Landroid/content/BroadcastReceiver;

    if-nez p2, :cond_1

    new-instance p2, Lcom/google/firebase/iid/FirebaseInstanceIdService$1;

    invoke-direct {p2, p0, p1}, Lcom/google/firebase/iid/FirebaseInstanceIdService$1;-><init>(Lcom/google/firebase/iid/FirebaseInstanceIdService;I)V

    sput-object p2, Lcom/google/firebase/iid/FirebaseInstanceIdService;->zzcln:Landroid/content/BroadcastReceiver;
...
.method private zzqG(I)V
    ...
    invoke-static {p0, v2, v1, v3}, Lcom/google/firebase/iid/zzg;->zza(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;
...
.method protected zzD(Landroid/content/Intent;)Landroid/content/Intent;
    ...
    invoke-virtual {p1}, Lcom/google/firebase/iid/zzg;->zzabV()Landroid/content/Intent;
...
.method public zzF(Landroid/content/Intent;)V
    ...
    invoke-direct {p0, v0, p1}, Lcom/google/firebase/iid/FirebaseInstanceIdService;->zza(Lcom/google/firebase/iid/zzf;Landroid/os/Bundle;)V
