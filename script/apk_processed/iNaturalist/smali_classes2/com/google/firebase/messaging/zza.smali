.class Lcom/google/firebase/messaging/zza;
.super Ljava/lang/Object;


# static fields
.field static zzclG:Lcom/google/firebase/messaging/zza;


# instance fields
.field private final mContext:Landroid/content/Context;

.field private zzaDS:Landroid/os/Bundle;

.field private final zzclH:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/google/firebase/messaging/zza;->zzclH:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method static zzE(Landroid/os/Bundle;)Z
    ...
    invoke-static {p0, v1}, Lcom/google/firebase/messaging/zza;->zzf(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0, v0}, Lcom/google/firebase/messaging/zza;->zzf(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
...
.method private zzGP()I
    ...
    iget-object v0, p0, Lcom/google/firebase/messaging/zza;->zzclH:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method private zzH(Landroid/os/Bundle;)Landroid/app/Notification;
    ...
    invoke-direct {p0, p1, v0}, Lcom/google/firebase/messaging/zza;->zzg(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    const-string v1, "gcm.n.body"

    invoke-direct {p0, p1, v1}, Lcom/google/firebase/messaging/zza;->zzg(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    const-string v2, "gcm.n.icon"

    invoke-static {p1, v2}, Lcom/google/firebase/messaging/zza;->zzf(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v2

    invoke-direct {p0, v2}, Lcom/google/firebase/messaging/zza;->zzeB(Ljava/lang/String;)I

    move-result v2

    const-string v3, "gcm.n.color"

    invoke-static {p1, v3}, Lcom/google/firebase/messaging/zza;->zzf(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v3

    invoke-direct {p0, v3}, Lcom/google/firebase/messaging/zza;->zzjD(Ljava/lang/String;)Ljava/lang/Integer;
    ...
    invoke-direct {p0, v4}, Lcom/google/firebase/messaging/zza;->zzeC(Ljava/lang/String;)Landroid/net/Uri;

    move-result-object v4

    invoke-direct {p0, p1}, Lcom/google/firebase/messaging/zza;->zzI(Landroid/os/Bundle;)Landroid/app/PendingIntent;

    move-result-object v5

    invoke-static {p1}, Lcom/google/firebase/messaging/FirebaseMessagingService;->zzX(Landroid/os/Bundle;)Z

    move-result v6

    if-eqz v6, :cond_0

    invoke-direct {p0, p1, v5}, Lcom/google/firebase/messaging/zza;->zza(Landroid/os/Bundle;Landroid/app/PendingIntent;)Landroid/app/PendingIntent;

    move-result-object v5

    invoke-direct {p0, p1}, Lcom/google/firebase/messaging/zza;->zzW(Landroid/os/Bundle;)Landroid/app/PendingIntent;
    ...
    invoke-virtual {v2, p1}, Landroid/support/v4/app/NotificationCompat$Builder;->setDeleteIntent(Landroid/app/PendingIntent;)Landroid/support/v4/app/NotificationCompat$Builder;
...
.method private zzI(Landroid/os/Bundle;)Landroid/app/PendingIntent;
    ...
    invoke-direct {p0, p1}, Lcom/google/firebase/messaging/zza;->zzV(Landroid/os/Bundle;)Landroid/content/Intent;
    ...
    invoke-static {v1}, Lcom/google/firebase/messaging/FirebaseMessagingService;->zzD(Landroid/os/Bundle;)V
    ...
    invoke-direct {p0}, Lcom/google/firebase/messaging/zza;->zzGP()I
...
.method static zzT(Landroid/os/Bundle;)Landroid/net/Uri;
    .locals 2
...
.method static zzU(Landroid/os/Bundle;)Ljava/lang/String;
    .locals 2
...
.method private zzV(Landroid/os/Bundle;)Landroid/content/Intent;
    .locals 2
...
.method private zzW(Landroid/os/Bundle;)Landroid/app/PendingIntent;
    ...
    invoke-direct {p0, v0, p1}, Lcom/google/firebase/messaging/zza;->zza(Landroid/content/Intent;Landroid/os/Bundle;)V
    ...
    invoke-static {p1, v1, v0, v2}, Lcom/google/firebase/iid/zzg;->zzb(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;
...
.method private zza(Landroid/os/Bundle;Landroid/app/PendingIntent;)Landroid/app/PendingIntent;
    ...
    invoke-static {p1, p2, v0, v1}, Lcom/google/firebase/iid/zzg;->zzb(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;
...
.method private zzacb()Landroid/os/Bundle;
    .locals 4

    iget-object v0, p0, Lcom/google/firebase/messaging/zza;->zzaDS:Landroid/os/Bundle;
    ...
    iput-object v0, p0, Lcom/google/firebase/messaging/zza;->zzaDS:Landroid/os/Bundle;
...
.method static declared-synchronized zzcx(Landroid/content/Context;)Lcom/google/firebase/messaging/zza;
    .locals 2
    ...
    :try_start_0
    sget-object v1, Lcom/google/firebase/messaging/zza;->zzclG:Lcom/google/firebase/messaging/zza;
    ...
    sput-object v1, Lcom/google/firebase/messaging/zza;->zzclG:Lcom/google/firebase/messaging/zza;

    :cond_0
    sget-object p0, Lcom/google/firebase/messaging/zza;->zzclG:Lcom/google/firebase/messaging/zza;
    :try_end_0
...
.method private zzeB(Ljava/lang/String;)I
    ...
    :cond_2
    invoke-direct {p0}, Lcom/google/firebase/messaging/zza;->zzacb()Landroid/os/Bundle;
...
.method private zzg(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p1, p2}, Lcom/google/firebase/messaging/zza;->zzf(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_0
    invoke-static {p1, p2}, Lcom/google/firebase/messaging/zza;->zzi(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    ...
    :goto_0
    invoke-static {p2}, Lcom/google/firebase/messaging/zza;->zzeA(Ljava/lang/String;)Ljava/lang/String;
...
.method static zzi(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    .locals 2
    ...
    :goto_0
    invoke-static {p0, p1}, Lcom/google/firebase/messaging/zza;->zzf(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
...
.method static zzj(Landroid/os/Bundle;Ljava/lang/String;)[Ljava/lang/Object;
    .locals 5
    ...
    :goto_2
    invoke-static {p1}, Lcom/google/firebase/messaging/zza;->zzeA(Ljava/lang/String;)Ljava/lang/String;
...
.method private zzjD(Ljava/lang/String;)Ljava/lang/Integer;
    .locals 4
...
.method zzG(Landroid/os/Bundle;)Z
    ...
    invoke-static {p1, v1}, Lcom/google/firebase/messaging/zza;->zzf(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_0
    invoke-direct {p0}, Lcom/google/firebase/messaging/zza;->zzaca()Z
    ...
    :cond_1
    invoke-direct {p0, p1}, Lcom/google/firebase/messaging/zza;->zzH(Landroid/os/Bundle;)Landroid/app/Notification;
    ...
    invoke-direct {p0, p1, v0}, Lcom/google/firebase/messaging/zza;->zza(Ljava/lang/String;Landroid/app/Notification;)V
