...
.method static constructor <clinit>()V
    ...
    .line 48
    new-array v3, v0, [Lorg/bouncycastle/math/ec/ECCurve$F2m;

    .line 49
    new-instance v4, Lorg/bouncycastle/math/ec/ECCurve$F2m;

    sget-object v22, Lorg/bouncycastle/asn1/ua/DSTU4145NamedCurves;->ONE:Ljava/math/BigInteger;

    new-instance v14, Ljava/math/BigInteger;

    const-string v15, "5FF6108462A2DC8210AB403925E638A19C1455D21"

    const/16 v0, 0x10

    invoke-direct {v14, v15, v0}, Ljava/math/BigInteger;-><init>(Ljava/lang/String;I)V
    ...
    invoke-direct/range {v17 .. v25}, Lorg/bouncycastle/math/ec/ECCurve$F2m;-><init>(IIIILjava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;)V
    ...
    const-string v14, "6EE3CEEB230811759F20518A0930F1A4315A827DAC"

    const/16 v15, 0x10

    invoke-direct {v4, v14, v15}, Ljava/math/BigInteger;-><init>(Ljava/lang/String;I)V
    ...
    sget-object v31, Lorg/bouncycastle/asn1/ua/DSTU4145NamedCurves;->ZERO:Ljava/math/BigInteger;

    new-instance v4, Ljava/math/BigInteger;

    const-string v14, "108576C80499DB2FC16EDDF6853BBB278F6B6FB437D9"

    const/16 v15, 0x10

    invoke-direct {v4, v14, v15}, Ljava/math/BigInteger;-><init>(Ljava/lang/String;I)V

    aget-object v33, v1, v6

    aget-object v34, v2, v6
    ...
    invoke-direct/range {v26 .. v34}, Lorg/bouncycastle/math/ec/ECCurve$F2m;-><init>(IIIILjava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;)V
    ...
    const-string v14, "4A6E0856526436F2F88DD07A341E32D04184572BEB710"
    ...
    sget-object v29, Lorg/bouncycastle/asn1/ua/DSTU4145NamedCurves;->ONE:Ljava/math/BigInteger;

    new-instance v4, Ljava/math/BigInteger;

    const-string v14, "7BC86E2102902EC4D5890E8B6B4981ff27E0482750FEFC03"
    ...
    invoke-direct/range {v26 .. v32}, Lorg/bouncycastle/math/ec/ECCurve$F2m;-><init>(IILjava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;)V
    ...
    const-string v14, "06973B15095675534C7CF7E64A21BD54EF5DD3B8A0326AA936ECE454D2C"
    ...
    sget-object v29, Lorg/bouncycastle/asn1/ua/DSTU4145NamedCurves;->ZERO:Ljava/math/BigInteger;
    ...
    const-string v14, "393C7F7D53666B5054B5E6C6D3DE94F4296C0C599E2E2E241050DF18B6090BDC90186904968BB"
    ...
    const-string v14, "43FC8AD242B0B7A6F3D1627AD5654447556B47BF6AA4A64B0C2AFE42CADAB8F93D92394C79A79755437B56995136"
    ...
    const-string v14, "03CE10490F6A708FC26DFE8C3D27C4F94E690134D5BFF988D8D28AAEAEDE975936C66BAC536B18AE2DC312CA493117DAA469C640CAF3"
    ...
    const-string v13, "2E2F85F5DD74CE983A5C4237229DAF8A3F35823BE"

    const/16 v12, 0x10

    invoke-direct {v15, v13, v12}, Ljava/math/BigInteger;-><init>(Ljava/lang/String;I)V

    new-instance v13, Ljava/math/BigInteger;

    const-string v11, "3826F008A8C51D7B95284D9D03FF0E00CE2CD723A"

    invoke-direct {v13, v11, v12}, Ljava/math/BigInteger;-><init>(Ljava/lang/String;I)V

    invoke-virtual {v14, v15, v13}, Lorg/bouncycastle/math/ec/ECCurve$F2m;->createPoint(Ljava/math/BigInteger;Ljava/math/BigInteger;)Lorg/bouncycastle/math/ec/ECPoint;
    ...
    invoke-direct {v14, v15, v12}, Ljava/math/BigInteger;-><init>(Ljava/lang/String;I)V

    invoke-virtual {v11, v13, v14}, Lorg/bouncycastle/math/ec/ECCurve$F2m;->createPoint(Ljava/math/BigInteger;Ljava/math/BigInteger;)Lorg/bouncycastle/math/ec/ECPoint;
    ...
    const-string v13, "4D41A619BCC6EADF0448FA22FAD567A9181D37389CA"

    invoke-direct {v11, v13, v12}, Ljava/math/BigInteger;-><init>(Ljava/lang/String;I)V

    new-instance v13, Ljava/math/BigInteger;

    const-string v14, "10B51CC12849B234C75E6DD2028BF7FF5C1CE0D991A1"

    invoke-direct {v13, v14, v12}, Ljava/math/BigInteger;-><init>(Ljava/lang/String;I)V

    invoke-virtual {v5, v11, v13}, Lorg/bouncycastle/math/ec/ECCurve$F2m;->createPoint(Ljava/math/BigInteger;Ljava/math/BigInteger;)Lorg/bouncycastle/math/ec/ECPoint;
    ...
    invoke-direct {v6, v11, v12}, Ljava/math/BigInteger;-><init>(Ljava/lang/String;I)V

    new-instance v11, Ljava/math/BigInteger;

    const-string v13, "25FBC363582DCEC065080CA8287AAFF09788A66DC3A9E"

    invoke-direct {v11, v13, v12}, Ljava/math/BigInteger;-><init>(Ljava/lang/String;I)V

    invoke-virtual {v5, v6, v11}, Lorg/bouncycastle/math/ec/ECCurve$F2m;->createPoint(Ljava/math/BigInteger;Ljava/math/BigInteger;)Lorg/bouncycastle/math/ec/ECPoint;
    ...
    invoke-direct {v6, v7, v12}, Ljava/math/BigInteger;-><init>(Ljava/lang/String;I)V

    new-instance v7, Ljava/math/BigInteger;

    const-string v11, "29C41E568B77C617EFE5902F11DB96FA9613CD8D03DB08DA"

    invoke-direct {v7, v11, v12}, Ljava/math/BigInteger;-><init>(Ljava/lang/String;I)V

    invoke-virtual {v5, v6, v7}, Lorg/bouncycastle/math/ec/ECCurve$F2m;->createPoint(Ljava/math/BigInteger;Ljava/math/BigInteger;)Lorg/bouncycastle/math/ec/ECPoint;
    ...
    invoke-direct {v7, v8, v12}, Ljava/math/BigInteger;-><init>(Ljava/lang/String;I)V
    ...
    invoke-virtual {v6, v7, v8}, Lorg/bouncycastle/math/ec/ECCurve$F2m;->createPoint(Ljava/math/BigInteger;Ljava/math/BigInteger;)Lorg/bouncycastle/math/ec/ECPoint;
    ...
    .line 72
    :goto_0
    sget-object v6, Lorg/bouncycastle/asn1/ua/DSTU4145NamedCurves;->params:[Lorg/bouncycastle/crypto/params/ECDomainParameters;
