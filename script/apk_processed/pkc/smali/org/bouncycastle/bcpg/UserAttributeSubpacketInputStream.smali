...
.method public readPacket()Lorg/bouncycastle/bcpg/UserAttributeSubpacket;
    ...
    invoke-direct {p0, v0, v1, v5}, Lorg/bouncycastle/bcpg/UserAttributeSubpacketInputStream;->readFully([BII)V

    if-eq v4, v2, :cond_4

    .line 118
    new-instance v1, Lorg/bouncycastle/bcpg/UserAttributeSubpacket;

    invoke-direct {v1, v4, v3, v0}, Lorg/bouncycastle/bcpg/UserAttributeSubpacket;-><init>(IZ[B)V
    ...
    invoke-direct {v1, v3, v0}, Lorg/bouncycastle/bcpg/attr/ImageAttribute;-><init>(Z[B)V
