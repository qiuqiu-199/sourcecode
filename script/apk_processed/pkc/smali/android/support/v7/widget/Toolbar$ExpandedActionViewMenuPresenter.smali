...
# instance fields
.field mCurrentExpandedItem:Landroid/support/v7/view/menu/j;

.field mMenu:Landroid/support/v7/view/menu/h;
...
.method public collapseItemActionView(Landroid/support/v7/view/menu/h;Landroid/support/v7/view/menu/j;)Z
    ...
    .line 2415
    iput-object v0, p0, Landroid/support/v7/widget/Toolbar$ExpandedActionViewMenuPresenter;->mCurrentExpandedItem:Landroid/support/v7/view/menu/j;
...
.method public expandItemActionView(Landroid/support/v7/view/menu/h;Landroid/support/v7/view/menu/j;)Z
    ...
    .line 2378
    iput-object p2, p0, Landroid/support/v7/widget/Toolbar$ExpandedActionViewMenuPresenter;->mCurrentExpandedItem:Landroid/support/v7/view/menu/j;
...
.method public initForMenu(Landroid/content/Context;Landroid/support/v7/view/menu/h;)V
    ...
    .line 2314
    iget-object p1, p0, Landroid/support/v7/widget/Toolbar$ExpandedActionViewMenuPresenter;->mMenu:Landroid/support/v7/view/menu/h;

    if-eqz p1, :cond_0

    iget-object p1, p0, Landroid/support/v7/widget/Toolbar$ExpandedActionViewMenuPresenter;->mCurrentExpandedItem:Landroid/support/v7/view/menu/j;
    ...
    iget-object v0, p0, Landroid/support/v7/widget/Toolbar$ExpandedActionViewMenuPresenter;->mCurrentExpandedItem:Landroid/support/v7/view/menu/j;

    invoke-virtual {p1, v0}, Landroid/support/v7/view/menu/h;->d(Landroid/support/v7/view/menu/j;)Z

    .line 2317
    :cond_0
    iput-object p2, p0, Landroid/support/v7/widget/Toolbar$ExpandedActionViewMenuPresenter;->mMenu:Landroid/support/v7/view/menu/h;
...
.method public updateMenuView(Z)V
    ...
    .line 2334
    iget-object v2, p0, Landroid/support/v7/widget/Toolbar$ExpandedActionViewMenuPresenter;->mMenu:Landroid/support/v7/view/menu/h;
    ...
    .line 2335
    iget-object v3, p0, Landroid/support/v7/widget/Toolbar$ExpandedActionViewMenuPresenter;->mCurrentExpandedItem:Landroid/support/v7/view/menu/j;
    ...
    invoke-virtual {p0, p1, v0}, Landroid/support/v7/widget/Toolbar$ExpandedActionViewMenuPresenter;->collapseItemActionView(Landroid/support/v7/view/menu/h;Landroid/support/v7/view/menu/j;)Z
